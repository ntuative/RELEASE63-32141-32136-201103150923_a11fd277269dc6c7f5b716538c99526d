package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_1588 || param2 != this.var_1587)
         {
      ...
      {
         if(this.var_1311 > 255 || bitmapData == null)
         {
            return false;
         }
