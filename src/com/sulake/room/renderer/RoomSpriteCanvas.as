package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1720:int = 50;
      ...
      private var var_127:Sprite;
      
      private var var_60:Sprite;
      
      private var var_586:Map;
      
      private var var_487:Point;
      
      private var var_251:BitmapDataCache;
      
      private var var_590:RoomObjectCache;
      
      private var var_488:Array;
      
      private var var_588:Array;
      
      private var var_1380:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2395:Number = -1.0E7;
      
      private var var_2397:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_252.addChild(this.var_60);
         ...
         this.var_590 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_487.x -= param1 - this.var_589;
         this.var_589 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_487.y -= param1 - this.var_587;
         this.var_587 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_841 = true;
            if(this.var_127 != null && !this.var_252.contains(this.var_127))
            {
               this.var_252.addChild(this.var_127);
               this.var_60.mask = this.var_127;
            }
         }
         else if(!param1 && this.var_841)
         {
            this.var_841 = false;
            if(this.var_127 != null && this.var_252.contains(this.var_127))
            {
               this.var_252.removeChild(this.var_127);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_588 != null)
         {
            ...
            {
               this.cleanSprite(this.var_588[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_588 = [];
         }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(this.var_127 != null)
         {
            this.var_127.graphics.clear();
         }
         else
         {
            this.var_127 = new Sprite();
            this.var_127.name = "mask";
            if(this.var_841)
            {
               this.var_252.addChild(this.var_127);
               this.var_60.mask = this.var_127;
         ...
         this.var_127.graphics.beginFill(0);
         this.var_127.graphics.drawRect(0,0,param1,param2);
         this.var_725 = param1;
         this._ht = param2;
      }
      ...
      {
         this.var_590.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_725 != this.var_2398 || this._ht != this.var_2399)
         {
            _loc9_ = true;
         }
         if(this.var_60.x != this.var_589 || this.var_60.y != this.var_587)
         {
            this.var_60.x = this.var_589;
            this.var_60.y = this.var_587;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_488.sortOn("z",0 | 0);
         if(_loc5_ < this.var_488.length)
         {
            this.var_488.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_488[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2398 = this.var_725;
         this.var_2399 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_590.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_590.getObjectCache(param2);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_587;
                  if(_loc19_ < this.var_725 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_488.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_589;
                     _loc17_.y = _loc20_ - this.var_587;
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_588.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function getSortableSprite(param1:int) : SortableSprite
      {
         ...
         return this.var_488[param1] as SortableSprite;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_589;
         param2 -= this.var_587;
         this.var_487.x = param1;
         this.var_487.y = param2;
         if(this.var_1127 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1713;
         }
         this.var_1713 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1127;
         return this.var_1713;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_725 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1712,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_586.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_586.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2395 || param2 != this.var_2397)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_586.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_586.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_346 != null && param1 != null)
         {
            this.var_346.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_346 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_346.getKey(_loc1_);
            _loc3_ = this.var_346.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1380.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1127 == 0)
         {
            this.checkMouseHits(this.var_487.x,this.var_487.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1127 = 0;
         ++this.var_1712;
      }
