package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      private var var_1726:Vector3d;
      
      private var var_492:Vector3d;
      
      private var _direction:Vector3d;
      
      private var var_1132:Vector3d;
      ...
      private var var_2831:Number = -500.0;
      
      private var var_2832:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1728 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_1726.assign(this.var_152);
         return this.var_1726;
      }
      
      public function get location() : IVector3d
      {
         this.var_492.assign(this.var_91);
         this.var_492.x *= this.var_411;
         this.var_492.y *= this.var_412;
         this.var_492.z *= this.var_413;
         return this.var_492;
      }
      
      public function get direction() : IVector3d
      {
         this._direction.assign(this.var_348);
         return this._direction;
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_411 != param1 * this.var_1727)
         {
            this.var_411 = param1 * this.var_1727;
            ++this.var_161;
         }
      }
      ...
      {
         if(this.var_412 != param1 * this.var_1725)
         {
            this.var_412 = param1 * this.var_1725;
            ++this.var_161;
         }
      }
      ...
      {
         if(this.var_413 != param1 * this.var_1728)
         {
            this.var_413 = param1 * this.var_1728;
            ++this.var_161;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_91.x /= this.var_411;
         this.var_91.y /= this.var_412;
         this.var_91.z /= this.var_413;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_348.x;
         var _loc3_:Number = this.var_348.y;
         var _loc4_:Number = this.var_348.z;
         this.var_348.assign(param1);
         if(this.var_348.x != _loc2_ || this.var_348.y != _loc3_ || this.var_348.z != _loc4_)
         {
            ++this.var_161;
         }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_491 != null)
         {
            ...
            return this.var_491.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1132.assign(_loc22_);
         }
         else
         {
            this.var_1132.assign(_loc17_);
         }
         ++this.var_161;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_411;
         _loc2_.y *= this.var_412;
         _loc2_.z *= this.var_413;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1132);
         if(_loc3_ < this.var_2831 || _loc3_ > this.var_2832)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_412;
            _loc2_.z *= this.var_413;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1132);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_91.x * this.var_411,this.var_91.y * this.var_412,this.var_91.z * this.var_413);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_152;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_411,param2.y * this.var_412,param2.z * this.var_413);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_411,param3.y * this.var_412,param3.z * this.var_413);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_411,param4.y * this.var_412,param4.z * this.var_413);
         var _loc14_:IVector3d = Vector3d.crossProduct(_loc12_,_loc13_);
         var _loc15_:Vector3d = new Vector3d();
         _loc15_.assign(RoomGeometry.getIntersectionVector(_loc9_,_loc10_,_loc11_,_loc14_));
         if(_loc15_ != null)
         {
            _loc15_.sub(_loc11_);
      ...
      public function performZoom() : void
      {
         ...
         {
            this.scale = const_646;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_646;
      }
