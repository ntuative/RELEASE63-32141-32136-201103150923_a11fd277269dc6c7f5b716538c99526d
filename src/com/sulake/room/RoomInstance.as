   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_249 != null)
         {
            ...
            {
               _loc3_ = this.var_249.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         if(this.var_1363.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      {
         if(this.var_1364.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_561.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_561[_loc2_]);
      ...
      public function createObjectInternal(param1:int, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         if(_loc5_ != null)
         {
            ...
            if(this.var_158 != null)
            {
               this.var_158.feedRoomObject(_loc6_);
            }
            return _loc6_;
         }
         return null;
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         if(this.var_249.getValue(_loc2_) != null)
         {
            return this.var_249.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_249.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_249.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_249.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_249.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
