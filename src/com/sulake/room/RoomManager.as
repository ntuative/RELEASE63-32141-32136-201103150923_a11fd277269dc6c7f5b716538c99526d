package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_563:IRoomObjectFactory = null;
      
      private var var_467:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1059:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_562 = [];
         this.var_561 = [];
         events.addEventListener(RoomContentLoadedEvent.const_389,this.onContentLoaded);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_563 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_563 == null || this.var_467 == null)
         {
            return;
         }
         this._state = const_1483;
         if(this.var_1059 != null)
         {
            _loc1_ = this.var_1059;
            this.var_1059 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_562.indexOf(_loc5_) < 0)
            {
               this.var_54.loadObjectContent(_loc5_,events);
               this.var_562.push(_loc5_);
            }
            _loc4_++;
         }
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_561.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_561[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_563.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_563 != null)
         {
            return this.var_563.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_746)
         {
            return;
         }
         if(this.var_54 == null)
         {
            this._state = const_746;
            return;
         }
         if(this.var_54.getGraphicAssetCollection(param1) != null)
         {
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(this.var_850.indexOf(_loc2_) < 0)
         {
            this.var_850.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_850.length > 0)
         {
            _loc2_ = this.var_850[0];
            this.var_850.splice(0,1);
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_54 == null || this.var_467 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_467.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_467.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_563.createRoomObjectLogic(_loc6_);
