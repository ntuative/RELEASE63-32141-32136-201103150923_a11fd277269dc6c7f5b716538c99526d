package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1023 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_43 = new Loader();
         this.var_1026 = new LoaderContext();
         this.var_1026.checkPolicyFile = true;
         ...
         {
            this.var_43.load(param2,this.var_1026);
         }
      }
      ...
      {
         this.var_1023 = param1.url;
         var_322 = 0;
         this.var_43.load(param1,this.var_1026);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_322 < var_2801)
            {
               ...
               this.var_43.load(new URLRequest(this.var_1023 + (this.var_1023.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_322),this.var_1026);
               return true;
            }
         }
         return false;
