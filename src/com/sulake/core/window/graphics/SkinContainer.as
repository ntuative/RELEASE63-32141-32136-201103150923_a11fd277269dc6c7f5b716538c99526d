package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_969:uint = 8;
      
      private static const const_1326:String = "skin";
      
      private static const const_1329:String = "bitmap";
      
      private static const const_1324:String = "fill";
      
      private static const const_1327:String = "text";
      
      private static const const_1325:String = "label";
      ...
      private var var_2519:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2521 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1796,this.var_2521);
         this.var_2520 = new Dictionary();
         this.var_2519 = new Dictionary();
         StateCodeTable.fillTables(this.var_2520,this.var_2519);
         this.var_421 = new Dictionary();
         this.var_421[const_1326] = BitmapSkinRenderer;
         this.var_421[const_1329] = BitmapDataRenderer;
         this.var_421[const_1324] = FillSkinRenderer;
         this.var_421[const_1327] = TextSkinRenderer;
         this.var_421[const_1325] = LabelRenderer;
         this.var_421[const_1328] = ShapeSkinRenderer;
         this.var_421[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_421[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_325 == null)
         {
            var_325 = new Array();
            var_325.push(WindowState.const_73);
            var_325.push(WindowState.const_84);
            var_325.push(WindowState.const_96);
            var_325.push(WindowState.const_54);
            var_325.push(WindowState.const_97);
            var_325.push(WindowState.const_83);
            var_325.push(WindowState.const_109);
         ...
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2785 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1796[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_939[param1] = new Array(const_969);
         }
         this.var_939[param1][param2] = param3;
         if(this.var_938[param1] == null)
         {
            this.var_938[param1] = new Array(const_969);
         }
         this.var_938[param1][param2] = param4;
      }
