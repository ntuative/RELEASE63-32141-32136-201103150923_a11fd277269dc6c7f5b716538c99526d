package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1394:uint = 0;
      
      public static const const_660:uint = 1;
      
      public static const const_1140:uint = 2;
      
      public static const const_726:uint = 4;
      
      public static const const_1408:uint = 8;
      
      public static const const_1516:uint = 16;
      
      public static const const_1804:uint = 64;
      
      public static const const_1774:uint = 128;
      
      public static const const_1136:uint = 256;
      
      protected static var var_545:uint = 0;
      
      protected static var var_326:uint = 0;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1408:
               ...
               break;
            case GraphicContext.const_1516:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_726:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1136:
               break;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_207.numChildren > 0)
               {
                  this.var_207.removeChildAt(0);
               }
            }
            this.var_207 = null;
            while(numChildren > 0)
         ...
         if(this.var_826)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_326 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2039,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2039,16777215);
                  }
                  var_326 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_826)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_326 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_207 == null)
         {
            ...
            this.var_207.name = this.name + " - Child Container";
            this.var_207.mouseEnabled = false;
      ...
      {
         return this.var_207 != null ? int(this.var_207.numChildren) : 0;
      }
