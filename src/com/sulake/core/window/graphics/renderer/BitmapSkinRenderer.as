package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_825:Dictionary;
      ...
      {
         super(param1);
         this.var_825 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            super.dispose();
            this.var_926 = null;
            for(_loc1_ in this.var_825)
            {
               _loc2_ = this.var_825[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_825[_loc1_];
            }
            this.var_825 = null;
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_455[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc16_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc10_.scaleH == SkinLayoutEntity.const_317)
                  {
                     var_34.x += _loc14_;
                  }
                  else if(_loc10_.scaleH == SkinLayoutEntity.const_423)
                  {
                     _loc12_ = true;
                  ...
                  if(_loc10_.scaleV == SkinLayoutEntity.const_317)
                  {
                     var_34.y += _loc15_;
                  }
                  else if(_loc10_.scaleV == SkinLayoutEntity.const_423)
                  {
                     _loc13_ = true;
                  ...
                  {
                     this.var_926.a = 0 / _loc17_.width;
                     this.var_926.d = 0 / _loc17_.height;
                     _loc30_ = new BitmapData(var_34.width,var_34.height,false);
                     _loc30_.draw(_loc17_,this.var_926);
                     _loc31_ = new BitmapData(var_34.width,var_34.height,true,0);
                     _loc31_.draw(_loc18_,this.var_926,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:ISkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.scaleH == SkinLayoutEntity.const_317)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.scaleV == SkinLayoutEntity.const_317)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_825[_loc3_];
         if(_loc4_ == null)
         {
