   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.getWindowRendererItem(param1).invalidate(param1,this.var_296,WindowRedrawFlag.const_1117);
      ...
      {
         var _loc2_:WindowRendererItem = this.var_352[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_352[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,this._drawBufferAllocator,this.var_917);
            this.var_352[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_765,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_765,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_352[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete this.var_352[param1];
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1751,this.var_1393))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1751,this.var_1393))
               {
