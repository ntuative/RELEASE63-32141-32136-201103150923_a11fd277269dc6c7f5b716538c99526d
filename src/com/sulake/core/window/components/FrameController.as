package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1265:String = "_TITLE";
      
      private static const const_1274:String = "_HEADER";
      
      private static const const_1276:String = "_CONTENT";
      ...
      private var var_1347:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1265) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1347 = findChildByTag(const_1274) as IHeaderWindow;
            if(!this.var_1347)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_184 = findChildByTag(const_1276) as IWindowContainer;
            if(!this.var_184)
            {
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1241,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1021 ? this.content.iterator : new Iterator(this);
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_261,_loc3_.left,PropertyStruct.const_41,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_229,_loc3_.top,PropertyStruct.const_41,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_262,0 - _loc3_.right,PropertyStruct.const_41,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_237,0 - _loc3_.bottom,PropertyStruct.const_41,_loc2_));
         }
         else
         {
