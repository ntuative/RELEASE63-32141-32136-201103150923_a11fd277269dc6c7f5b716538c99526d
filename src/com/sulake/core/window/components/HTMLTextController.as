package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_888:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_887:String = "default";
      
      private var var_1113:String = null;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1113 == param2)
         {
            return;
         }
         param1.var_1113 = param2;
         param1.var_1677 = null;
         if(param1.var_1113 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1113);
      ...
      {
         if(PropertyDefaults.const_783.indexOf(param1) > -1)
         {
            this.var_887 = param1;
         }
      }
      ...
      {
         return this.var_887 == LinkTarget.const_31 ? defaultLinkTarget : this.var_887;
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_670)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_887 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_750,this.var_887,PropertyStruct.const_56,true,PropertyDefaults.const_783));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1648);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_887 = _loc2_.value as String;
               break;
            }
