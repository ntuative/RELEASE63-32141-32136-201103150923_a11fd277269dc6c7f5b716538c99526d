package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1280:String = "_SELECTOR";
      
      private static const const_1279:String = "_CONTENT";
       
      
      protected var var_1020:ITabSelectorWindow;
      
      protected var var_2033:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1020 = findChildByTag(const_1280) as ITabSelectorWindow;
            if(this.var_1020 != null)
            {
               this.var_1020.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2033 = findChildByTag(const_1279) as IWindowContainer;
         }
      ...
      {
         return !!this.var_669 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1020.numSelectables;
      }
