package com.sulake.core.window.components
{
   ...
   public class TabButtonController extends SelectableController implements ITabButtonWindow
   {
      ...
      private static const const_1743:String = "TAB_BUTTON_CONTENT";
      
      private static const const_1383:String = "TAB_BUTTON_TITLE";
      
      private static const const_1742:String = "TAB_BUTTON_ICON";
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:IWindow = findChildByTag(const_1383);
         if(_loc2_ != null)
         {
