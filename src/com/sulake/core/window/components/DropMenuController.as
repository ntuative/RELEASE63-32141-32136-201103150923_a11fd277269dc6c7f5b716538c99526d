package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      {
         if(param1 > this.var_246.lenght - 1)
         {
            throw new Error("Menu selection index out of range!");
         }
         var _loc2_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_576,this,null,true);
         ...
         if(!_loc2_.isWindowOperationPrevented())
         {
            ...
            this.var_574 = param1;
            this.closeMenuView();
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_345,this,null);
            this.update(this,_loc2_);
         }
         _loc2_.recycle();
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_180 == null || this.var_180.disposed)
         {
            this.var_180 = context.create(name + "::submenu","",WindowType.const_436,var_84,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_246.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_885 = true;
         this.closeMenuView();
      ...
      protected function openMenuView() : void
      {
         if(!this.var_885)
         {
            if(this.open())
            {
               if(this.var_246.length)
               {
                  this.populateMenuItemContainer(this.var_246,this.getSubMenu(),this.subMenuEventProc);
                  this.var_885 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_885 = false;
            this.getTitleLabel().text = this.var_574 < this.var_246.length && this.var_574 > -1 ? this.var_246[this.var_574] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_468,var_84,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_364,var_84,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         {
            _loc4_.getListItemAt(this.var_574).setStateFlag(WindowState.const_54,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_46 || param1.type == WindowTouchEvent.const_462)
         {
      ...
      public function open() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1005,this,null);
         ...
         visible = true;
         _loc1_.type = WindowNotifyEvent.const_1187;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1077,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_246[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_246.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_880,this.var_246,PropertyStruct.const_149,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_880)
            {
