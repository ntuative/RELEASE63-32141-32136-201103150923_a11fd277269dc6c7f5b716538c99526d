package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         {
            this.method_1(param1 as IWindow);
         }
         else if(param2.type == WindowNotifyEvent.const_668)
         {
            return true;
         }
      ...
      public function method_1(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_823;
         if(this.var_823 != param1)
         {
            if(this.var_823 != null)
            {
               if(!this.var_823.disposed)
               {
                  this.var_823.deactivate();
               }
            }
            this.var_823 = param1;
