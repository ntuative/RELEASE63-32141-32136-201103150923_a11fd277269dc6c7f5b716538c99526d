package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      private var var_205:ISelectableWindow;
      
      protected var var_2018:Boolean = true;
      ...
      {
         return this.var_205 as ISelectableWindow;
      }
      ...
      public function setSelected(param1:ISelectableWindow) : void
      {
         ...
         if(param1 != null)
         {
            if(param1 != this.var_205)
            {
               if(this.var_205 != null)
               {
                  this.var_205.unselect();
               }
               this.var_205 = param1;
               this.var_205.select();
               if(getChildIndex(param1) > -1)
               {
                  ...
                  _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_345,this,this.var_205);
