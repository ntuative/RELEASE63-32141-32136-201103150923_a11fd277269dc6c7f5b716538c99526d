package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1523:uint = 500;
      
      protected var var_1270:String = "";
      
      protected var var_1262:Boolean = false;
      
      protected var var_669:Boolean = false;
      ...
      {
         this.var_1270 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_22)
         {
            var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1140,var_11);
         }
         return var_22;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_462)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_669 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_391,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_758,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1505);
         _loc1_.push(this.var_1262 != PropertyDefaults.const_1239 ? new PropertyStruct(PropertyDefaults.const_891,this.var_1262,PropertyStruct.const_38,true) : PropertyDefaults.const_1680);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1091 ? new PropertyStruct(PropertyDefaults.const_618,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1575);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1083 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1684);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_891:
                  this.var_1262 = _loc2_.value as Boolean;
                  if(this.var_1262)
                  {
               ...
               case PropertyDefaults.const_758:
                  ...
                  break;
               case PropertyDefaults.const_1220:
