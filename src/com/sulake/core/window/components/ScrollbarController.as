package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1332:String = "increment";
      
      private static const const_1331:String = "decrement";
      
      private static const const_970:String = "slider_track";
      
      private static const const_605:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_665:Number = 0.1;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_18 != null && !this.var_18.disposed)
         {
            ...
            this.var_18.removeEventListener(WindowEvent.const_438,this.onScrollableScrolled);
         }
         this.var_18 = param1;
         if(this.var_18 != null && !this.var_18.disposed)
         {
            this.var_18.addEventListener(WindowEvent.const_50,this.onScrollableResized);
            this.var_18.addEventListener(WindowEvent.const_438,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_940 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_970) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_605) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_605:
         ...
         if(param2.type == WindowNotifyEvent.const_549)
         {
            if(this.var_18 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_289)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_665;
                  }
                  else
                  {
                     this.scrollV -= this.var_665;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_46 || param1.type == WindowTouchEvent.const_462)
         {
            ...
            else if(param2.name == const_1331)
            {
               if(this.var_18)
               {
                  this.var_1169 = true;
            ...
            else if(param2.name == const_970)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_605).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_940) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_940) as IScrollableWindow;
               if(_loc1_)
               {
