package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1240:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_822:Number;
      ...
      protected var var_1019:Boolean = false;
      
      private var var_401:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_401,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_401 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_401,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_862 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_401);
      }
      ...
      {
         this.var_822 = param1;
         this._field.scrollH = this.var_822 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_822 * this.maxScrollH,this.var_540 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_401);
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_1168) ? new PropertyStruct(PropertyDefaults.const_836,this._field.antiAliasType,PropertyStruct.const_56,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1014) : PropertyDefaults.const_1436);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1041 ? new PropertyStruct(PropertyDefaults.const_678,this._autoSize,PropertyStruct.const_56,true,PropertyDefaults.const_1165) : PropertyDefaults.const_1579);
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1073 ? new PropertyStruct(PropertyDefaults.const_1181,this._field.gridFitType,PropertyStruct.const_56,true,PropertyDefaults.const_1186) : PropertyDefaults.const_1672);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_704) ? new PropertyStruct(PropertyDefaults.const_361,this._field.textColor,PropertyStruct.const_131,true) : PropertyDefaults.const_1109);
         _loc1_.push(this.var_401 != TextStyleManager.const_197 ? new PropertyStruct(PropertyDefaults.const_367,this.var_401,PropertyStruct.const_56,true,PropertyDefaults.const_796) : PropertyDefaults.const_1042);
         _loc1_.push(this.var_41.left != PropertyDefaults.const_773 ? new PropertyStruct(PropertyDefaults.const_261,this.var_41.left,PropertyStruct.const_41,true) : PropertyDefaults.const_543);
         _loc1_.push(this.var_41.top != PropertyDefaults.const_865 ? new PropertyStruct(PropertyDefaults.const_229,this.var_41.top,PropertyStruct.const_41,true) : PropertyDefaults.const_551);
         _loc1_.push(this.var_41.right != PropertyDefaults.const_776 ? new PropertyStruct(PropertyDefaults.const_262,this.var_41.right,PropertyStruct.const_41,true) : PropertyDefaults.const_537);
         _loc1_.push(this.var_41.bottom != PropertyDefaults.const_792 ? new PropertyStruct(PropertyDefaults.const_237,this.var_41.bottom,PropertyStruct.const_41,true) : PropertyDefaults.const_570);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1054 ? new PropertyStruct(PropertyDefaults.const_837,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1614);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_258,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_258,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_258,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
