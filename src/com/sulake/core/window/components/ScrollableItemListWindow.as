package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1116:IItemListWindow;
      
      private var var_406:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_406)
         {
            this.var_406.removeEventListener(WindowEvent.const_304,this.scrollBarEventProc);
            this.var_406.removeEventListener(WindowEvent.const_259,this.scrollBarEventProc);
            this.var_406 = null;
         }
         if(this.var_1116)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1116)
         {
            this.var_1116 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_406)
         {
            this.var_406 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_406)
            {
               this.var_406.addEventListener(WindowEvent.const_304,this.scrollBarEventProc);
               this.var_406.addEventListener(WindowEvent.const_259,this.scrollBarEventProc);
            }
         }
         return this.var_406;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_259)
         {
            this.hideScrollBar();
         }
      }
