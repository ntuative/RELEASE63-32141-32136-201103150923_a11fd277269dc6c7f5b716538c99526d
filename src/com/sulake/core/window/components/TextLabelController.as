package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_401);
         if(_loc1_)
         {
      ...
      {
         if(this.var_401 != param1.name)
         {
            this.var_401 = param1.name;
            this.refresh();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_368 != _loc2_.color : this.var_368 != null && this.var_368 != PropertyDefaults.const_704) ? new PropertyStruct(PropertyDefaults.const_361,this.var_368,PropertyStruct.const_131,true) : PropertyDefaults.const_1109);
         if(this.var_41)
         {
            if(this.var_41.left != PropertyDefaults.const_773)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_261,this.var_41.left,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_543);
            }
            if(this.var_41.top != PropertyDefaults.const_865)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_229,this.var_41.top,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_551);
            }
            if(this.var_41.right != PropertyDefaults.const_776)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_262,this.var_41.right,PropertyStruct.const_41,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_537);
            }
            if(this.var_41.bottom != PropertyDefaults.const_792)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_237,this.var_41.bottom,PropertyStruct.const_41,true));
            }
            else
            {
