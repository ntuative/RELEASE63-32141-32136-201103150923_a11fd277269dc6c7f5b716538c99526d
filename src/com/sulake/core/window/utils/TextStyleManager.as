package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_477:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_591:String = "{";
      
      private static const const_590:String = "}";
      
      private static const const_1294:String = "/*";
      
      private static const const_1293:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_87[const_197],var_87[ITALIC],var_87[BOLD]];
            var_87.reset();
            var_87[const_197] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_477.indexOf(_loc4_.name) == -1)
            {
               var_477.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_590);
         if(countSubStrings(param1,const_591) != countSubStrings(param1,const_590))
         {
            throw new Error("Mismatching amount of \"" + const_591 + "\" versus \"" + const_590 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1294) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1293) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_591)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
