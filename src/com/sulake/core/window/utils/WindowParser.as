package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1150:String = "_EXCLUDE";
      
      public static const const_1801:String = "_INCLUDE";
      
      public static const const_1875:String = "_TEMP";
      
      private static const const_1340:String = "layout";
      
      private static const const_974:String = "window";
      
      private static const const_973:String = "variables";
      
      private static const const_972:String = "filters";
      
      private static const const_606:String = "name";
      
      private static const const_1343:String = "style";
      
      private static const const_608:String = "params";
      
      private static const const_1345:String = "tags";
      
      private static const X:String = "x";
      
      private static const Y:String = "y";
      
      private static const const_1322:String = "width";
      
      private static const const_1321:String = "height";
      
      private static const const_1341:String = "visible";
      
      private static const const_1333:String = "caption";
      ...
      private static const const_1342:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1336:String = "treshold";
      
      private static const const_1335:String = "children";
      
      private static const const_1339:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1346:String = "height_min";
      
      private static const const_1334:String = "height_max";
      
      private static const const_607:String = "true";
      
      private static const const_166:String = "0";
      
      private static const const_1344:String = "$";
      
      private static const const_1323:String = ",";
      ...
      protected var var_1268:Dictionary;
      
      protected var var_1267:Dictionary;
      
      protected var var_1024:Dictionary;
      
      protected var var_1522:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1268,this.var_1267);
         this.var_1024 = new Dictionary();
         this.var_1522 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1024,this.var_1522);
      ...
      private static function trimWhiteSpace(param1:String) : String
      {
         ...
         return param1.replace(const_1338,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1268)
            {
               delete this.var_1268[_loc1_];
            }
            for(_loc1_ in this.var_1267)
            {
               delete this.var_1267[_loc1_];
            }
            for(_loc1_ in this.var_1024)
            {
               delete this.var_1024[_loc1_];
            }
            for(_loc1_ in this.var_1522)
            {
               delete this.var_1522[_loc1_];
            }
            this.var_2038.dispose();
            this.var_2038 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1340)
         {
            _loc8_ = param1.child(const_973);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_972).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1268[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_606,variables,"")));
         style = uint(this.parseAttribute(xml,const_1343,variables,style));
         params = uint(this.parseAttribute(xml,const_608,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1345,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_166));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_166));
         rect.width = Number(this.parseAttribute(xml,const_1322,variables,const_166));
         rect.height = Number(this.parseAttribute(xml,const_1321,variables,const_166));
         visible = this.parseAttribute(xml,const_1341,variables,visible.toString()) == const_607;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_608).length() > 0)
         {
            list = xml.child(const_608).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               ...
               if(this.var_1024[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_606)) + "\"!");
               }
               params |= this.var_1024[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_49) : const_49;
         caption = unescape(String(this.parseAttribute(xml,const_1333,variables,caption)));
         if(tag != const_49)
         {
            tags = tag.split(const_1323);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_973)[0]),tags) as WindowController;
         ...
         window.limits.minHeight = int(this.parseAttribute(xml,const_1346,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1334,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_607;
         blend = Number(this.parseAttribute(xml,const_1170,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1342,variables,window.clipping.toString()) == const_607;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1336,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_972).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_49;
         var _loc3_:String = this.var_1267[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1150) == -1)
                  {
