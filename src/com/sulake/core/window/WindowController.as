package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected static const const_1241:String = "_COLORIZE";
      
      protected static const const_1694:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_958:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            ...
            var_64 = var_393.clone();
            var_11 = var_393.clone();
         ...
         if(_loc13_)
         {
            var_691 = _loc13_.blend;
            var_456 = _loc13_.var_2785;
            if(var_457 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_233 != _loc13_.color)
            {
      ...
      {
         return this.var_664 != null ? this.var_664 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_457 = param1;
         var_233 = !!var_457 ? uint(var_233 | var_544) : uint(var_233 & 16777215);
      ...
      {
         var_544 = param1 & 4278190080;
         var_233 = !!var_457 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.REDRAW);
      }
      ...
      {
         var_544 = param1 << 24;
         var_233 = !!var_457 ? uint(var_544 | var_233) : uint(16777215 & var_233);
         _context.invalidate(this,var_11,WindowRedrawFlag.REDRAW);
      }
      
      public function set blend(param1:Number) : void
      {
         var_691 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_532,this,null);
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_84 = param1;
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_535,this,null);
            this.update(this,_loc2_);
            _loc2_.recycle();
         }
      }
      ...
      public function set clipping(param1:Boolean) : void
      {
         ...
         {
            var_667 = param1;
            _loc2_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_431,this,null);
            this.update(this,_loc2_);
            _loc2_.recycle();
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               ...
               _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_549,this,this._parent);
            ...
            else
            {
               ...
               _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1173,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_22 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_660,var_11);
            this.var_22.visible = var_310;
         }
         return this.var_22;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_84,var_20,_context,var_11,null,this.var_664,this.properties,var_828.concat(),_id) as WindowController;
         ...
         _loc2_.var_233 = var_233;
         _loc2_.var_544 = var_544;
         _loc2_.var_667 = var_667;
         _loc2_.var_310 = var_310;
         _loc2_.var_691 = var_691;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2467 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            else if(_loc7_ == WindowParam.const_449)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1131,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_797,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_439,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
            {
               _loc9_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_183,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
         }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc9_:* = null;
         var _loc10_:* = 0;
         if(!testParamFlag(WindowParam.const_828))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_46:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1102;
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_183:
                  ...
                  if(param1 == this)
                  {
                     _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_505,this,null);
                     this.notifyChildren(_loc6_);
                     _loc6_.recycle();
                     if(testParamFlag(WindowParam.const_187,WindowParam.const_163))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_196,WindowParam.const_162))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc10_ = uint(var_20);
                        var_20 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_497))
                        {
               ...
               case WindowNotifyEvent.const_439:
                  _context.invalidate(this,var_11.union(var_64),WindowRedrawFlag.const_513);
                  if(param1 == this)
                  {
                     _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1023,this,null);
                     this.notifyChildren(_loc6_);
                     _loc6_.recycle();
                     if(this._parent != null)
                     {
                        _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_310,this._parent,this);
                        this._parent.update(this,_loc6_);
                        _loc6_.recycle();
                     }
                  }
               ...
               case WindowNotifyEvent.const_370:
                  if(param1 == this)
                  {
                     _loc6_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_668,this,null);
                     this.notifyChildren(_loc6_);
                     _loc6_.recycle();
                     if(this._parent != null)
                     {
               ...
               case WindowNotifyEvent.const_532:
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_1180);
                  break;
               case WindowNotifyEvent.const_535:
                  ...
                  while(--_loc8_ > -1)
                  {
                     ...
                     if(_loc9_.tags.indexOf(const_1694) == -1)
                     {
                        _loc9_.style = var_84;
                     }
                  }
               ...
               case WindowNotifyEvent.const_431:
                  if(!(var_20 & 0))
                  {
                     if(!this.var_22)
                     {
                        ...
                        _context.invalidate(this,var_11,WindowRedrawFlag.const_513);
                     }
                  }
                  else if(var_20 & 0)
                  {
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1237:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1619:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1520:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_1005:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1187:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_1018:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1230:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_431:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_668:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.WINDOW_NOTIFY_CHILD_ACTIVATED:
               _loc2_ = "null";
         ...
         if(this.var_174 && var_456 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_958,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_958,param3,param1)) : false;
            }
         }
      ...
      public function setStateFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(_state != _loc3_)
         {
            _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_532,this,null);
            this.update(this,_loc4_);
            _loc4_.recycle();
         }
      }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_84 != _loc3_)
         {
            _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_535,this,null);
            this.update(this,_loc4_);
            _loc4_.recycle();
         }
      }
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_20 != _loc3_)
         {
            _loc4_ = WindowNotifyEvent.allocate(WindowNotifyEvent.const_431,this,null);
            this.update(this,_loc4_);
            _loc4_.recycle();
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_154,WindowParam.const_163);
         var _loc2_:* = !testParamFlag(WindowParam.const_136,WindowParam.const_162);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_371)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_378)
               {
                  _loc3_.x += _loc4_;
               }
            ...
            if(_loc2_)
            {
               ...
               _loc5_ = uint(var_20 & 0);
               if(_loc5_ == WindowParam.const_321)
               {
      ...
      public function destroy() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1208,this,null);
         ...
         _loc1_.type = WindowNotifyEvent.const_1063;
         this.update(this,_loc1_);
         _loc1_.recycle();
         this.dispose();
         return true;
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1019,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      {
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1134,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.type = WindowNotifyEvent.const_1155;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      {
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1146,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1126,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.type = WindowNotifyEvent.const_1237;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1015,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1230,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1219,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1214,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1090,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.type = WindowNotifyEvent.const_1162;
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_1236,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1144 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc3_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_351,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1144 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc4_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_351,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowNotifyEvent = WindowNotifyEvent.allocate(WindowNotifyEvent.const_685,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
