package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1323:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1324:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_155:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_155 = this.profiler;
         this._windowManager = param2;
         this.var_918 = param3;
         var _loc4_:ByteArray = new var_1323() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_155)
         {
            this.var_155.removeStopEventListener(this.refresh);
            this.var_155 = null;
         }
         if(!this.var_155 && param1)
         {
            this.var_155 = param1;
            this.var_155.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_771)
            {
               this.var_1600 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_155.getProfilerAgentsInArray();
         ...
         if(this.var_1600)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_155.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_155.numBitmapAssetInstances + " / " + this.var_155.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_918.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_155.numTrackedBitmapDataInstances + " / " + this.var_155.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1324() as ByteArray;
