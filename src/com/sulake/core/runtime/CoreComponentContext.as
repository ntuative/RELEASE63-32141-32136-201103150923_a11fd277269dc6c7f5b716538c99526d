package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1287:String = "asset-libraries";
      
      private static const const_1290:String = "library";
      
      private static const const_1289:String = "service-libraries";
      
      private static const const_1282:String = "library";
      
      private static const const_1286:String = "component-libraries";
      
      private static const const_1288:String = "library";
      
      private static const const_1284:String = "error_data";
      
      private static const const_1283:String = "error_cat";
      
      private static const const_1285:String = "error_desc";
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         var_390.addEventListener(Event.ENTER_FRAME,this.onEnterFrame);
         switch(param2 & 0)
         {
            case Core.const_1046:
            ...
            case Core.const_619:
               ...
               var_390.addChild(new ProfilerViewer(this.var_197));
               break;
            case Core.const_545:
      ...
      {
         return this.var_475 - this.getNumberOfFilesPending();
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < CoreComponentContext.const_102)
            {
               _loc2_ = this.var_247[_loc4_] as Array;
            ...
            if(var_390)
            {
               var_390.removeEventListener(Event.ENTER_FRAME,this.onEnterFrame);
               var_390 = null;
            }
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1284,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1283,String(param3));
         ErrorReportStorage.setParameter(const_1285,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         try
         {
            node = config.child(const_1287)[0];
            if(node != null)
            {
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_279,e);
         }
         try
         {
            node = config.child(const_1289)[0];
            if(node != null)
            {
               list = node.child(const_1282);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_279,e);
         }
         try
         {
            node = config.child(const_1286)[0];
            if(node != null)
            {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_279,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1591);
         if(!disposed)
         {
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_706)
                  {
                     this.var_706.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_475 - this.var_341.length,this.var_475,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_197 ? 0 : this.var_1355 & 0;
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:* = null;
         var _loc4_:int = !!this.var_197 ? 0 : this.var_1355 & 0;
         var _loc5_:int = 0;
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         var msCurrentTime:uint = param1;
         var msSinceLastUpdate:uint = param2;
         var maxTimePerFrame:uint = 1000 / var_390.stage.frameRate;
         priority = 0;
         while(priority < CoreComponentContext.const_102)
         {
            t = getTimer();
            ...
            {
               if(this.var_575[priority] < priority)
               {
                  ++this.var_575[priority];
                  skip = true;
               }
            }
            if(!skip)
