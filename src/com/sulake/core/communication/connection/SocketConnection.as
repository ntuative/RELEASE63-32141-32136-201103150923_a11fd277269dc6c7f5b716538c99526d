package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1561:int = 10000;
      ...
      private var var_1224:IEncryption;
      
      private var var_786:IProtocol;
      
      private var _id:String;
      
      private var var_1223:IMessageClassManager;
      
      private var var_308:ICoreCommunicationManager;
      
      private var var_523:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_1223 = new MessageClassManager();
         this.var_83 = new Socket();
         this.var_375 = new Timer(const_1561,1);
         this.var_375.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_523)
         {
            this.var_523.connectionInit(param1,param2);
         }
      ...
      {
         this.var_375.delay = param1;
      }
      
      public function addMessageEvent(param1:IMessageEvent) : void
      {
         this.var_308.addConnectionMessageEvent(this._id,param1);
      }
      
      public function removeMessageEvent(param1:IMessageEvent) : void
      {
         this.var_308.removeConnectionMessageEvent(this._id,param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1223.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            this.logConnection("Could not find registered message composer for " + param1);
            return false;
         }
         var _loc5_:ByteArray = this.var_786.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(this.var_523)
         {
            this.var_523.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(this.var_1224 != null)
         {
            _loc3_ = this.var_1224.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      {
         this.var_1223.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + this.var_1224 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_786.getMessages(this.var_524,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_523)
               {
                  this.var_523.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1223.getMessageEventClasses(id);
               events = new Array();
               for each(eventClass in eventClasses)
               {
                  eventsForClass = this.var_308.getMessageEvents(this,eventClass);
               ...
               for each(messageEventInstance in events)
               {
                  ...
                  if(parserClass != null)
                  {
                     ...
                     if(parserClass != parserClassCurrent)
                     {
                        ...
                        parserInstance = this.var_308.getMessageParser(parserClass);
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_524.writeByte(this.var_83.readUnsignedByte());
         }
      }
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         _loc2_.text = "Socket Timeout (" + this.var_375.delay + " ms). Possible Firewall.";
