package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_593:Map = new Map();
      
      private static const const_328:Map = new Map();
      
      private static var var_1121:Boolean = false;
      ...
      {
         return const_593.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1121)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_593.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1121 = true;
         }
