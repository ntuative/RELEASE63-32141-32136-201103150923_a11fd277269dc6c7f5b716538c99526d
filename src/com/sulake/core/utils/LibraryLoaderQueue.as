package com.sulake.core.utils
{
   ...
   public class LibraryLoaderQueue extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1550:int = 4;
      ...
      {
         return this.var_418.length + this.var_278.length;
      }
      ...
      private function next() : void
      {
         ...
         if(!disposed)
         {
            while(this.var_278.length < const_1550 && this.var_418.length > 0)
            {
               _loc1_ = this.var_418.shift();
      ...
      private function removeLoader(param1:LibraryLoader) : void
      {
         ...
         try
         {
            index = this.var_418.indexOf(loader);
            if(index > -1)
            {
               this.var_418.splice(index,1);
            }
