package com.sulake.core.utils
{
   ...
   public class XMLVariableParser
   {
      ...
      public static const const_1633:String = "float";
      
      public static const const_38:String = "Boolean";
      
      public static const const_1519:String = "bool";
      ...
      private static const const_1728:String = "FurnitureAliasesMessageEvent";
      ...
      private static function parseVariableToken(param1:XML, param2:Map, param3:Array = null) : void
      {
         ...
         else
         {
            ...
            else if(_loc5_ == const_268 || _loc5_ == const_149)
            {
      ...
      public static function castStringToType(param1:String, param2:String) : Object
      {
         switch(param2)
         {
            ...
            case const_1633:
               return Number(param1);
            case const_38:
               return param1 == const_607 || int(param1) > 0;
            case const_1519:
               return param1 == const_607 || int(param1) > 0;
            case const_131:
               return uint(param1);
            case const_149:
               return param1.split(const_1323);
            default:
      ...
      public static function parseValueType(param1:XML, param2:String) : Object
      {
         ...
         switch(param2)
         {
            ...
            case const_246:
               ...
               _loc5_.width = Number(param1.attribute(const_1322));
               _loc5_.height = Number(param1.attribute(const_1321));
               return _loc5_;
            case const_149:
               _loc3_ = new Map();
