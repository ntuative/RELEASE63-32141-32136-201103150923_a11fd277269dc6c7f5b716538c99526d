package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2014:String = "open_issues";
      
      private const const_2015:String = "picked_issues";
      
      private const const_2033:String = "closed_issues";
      ...
      private var var_1667:IIssueBrowserView;
      
      private var var_1665:IIssueBrowserView;
      
      private var var_1666:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_342.view.width = this.var_248.container.width;
         this.var_342.view.height = this.var_248.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2013:
               ...
               {
                  this.var_1667 = new MyIssuesView(this.issueManager,this,this.var_248.container);
               }
               return this.var_1667;
            case this.const_2014:
               if(this.var_1665 == null)
               {
                  this.var_1665 = new OpenIssuesView(this.issueManager,this,this.var_248.container);
               }
               return this.var_1665;
            case this.const_2015:
               if(this.var_1666 == null)
               {
                  this.var_1666 = new PickedIssuesView(this.issueManager,this,this.var_248.container);
               }
