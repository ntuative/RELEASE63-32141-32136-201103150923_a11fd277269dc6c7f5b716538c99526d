package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_835:Array = [];
      
      private static var var_1539:int = 200;
      ...
      {
         this.var_673 = IWindowContainer(this.var_35.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1504;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_835.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_673.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_835.length < var_1539)
         {
            ...
            param1.width = this.var_673.width;
            param1.height = this.var_673.height;
            var_835.push(param1);
         }
         else
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1280)
         {
