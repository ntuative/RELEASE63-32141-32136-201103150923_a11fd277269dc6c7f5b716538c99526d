package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         if(_loc9_.length() > 0)
         {
            ...
            while(_loc10_ < _loc9_.length())
            {
               ...
               if(_loc8_ != null)
               {
                  this.var_990.push(_loc11_);
                  this.var_991.push(_loc8_);
               }
               _loc10_++;
            }
         }
         else
         {
            ...
            if(_loc8_ != null)
            {
               this.var_990.push(new XML());
               this.var_991.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            this.var_991[this._frame] = param6.clone();
         }
      ...
      {
         if(this.var_1480 == true || this.var_992 == 0)
         {
            if(this.var_990.length > 0)
            {
               ++this._frame;
      ...
      {
         return this.var_990.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1480 == false && this.var_992 == 1 && this.var_1759 != this._state;
      }
      ...
      {
         var _loc2_:* = null;
         if(this._frame <= this.var_991.length)
         {
            _loc2_ = this.var_991[this._frame];
