package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1490:LogoutController;
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_308.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
      }
      ...
      {
         this.var_16 = new ToolbarView(this._windowManager,this._assetLibrary,this.var_308.getHabboMainConnection(null),events);
         if(this._config && this._config.getKey("client.logout.enabled","FurnitureAliasesMessageEvent") == "true")
         {
            this.var_1490 = new LogoutController(this._windowManager,this._assetLibrary,events);
         }
         if(this.var_16 == null)
         {
            return;
         }
         events.addEventListener(HabboToolbarSetIconEvent.const_129,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1183,this.onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_135,this.onRemoveToolbarIconEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_469,this.onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1137,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1148,this.onHideWindowEvent);
         this._state = true;
