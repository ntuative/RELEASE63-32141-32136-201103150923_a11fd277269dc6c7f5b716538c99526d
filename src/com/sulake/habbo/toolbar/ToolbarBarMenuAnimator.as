package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1313:Number = 25;
      
      private static const const_1370:Number = 90;
      
      private static const const_957:int = 50;
      
      private static const const_1314:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1389:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_743 = new Timer(const_1313);
         this.var_743.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      {
         return param1.x + param1.width < const_957 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_957 || param1.desktop.height - param1.y < const_1314;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1389.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = this.var_1389.getIconLoc(param1.iconId);
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_605.indexOf(param2);
         if(_loc3_ > -1)
         {
         ...
         param1.addEventListener(WindowEvent.const_385,this.windowEventListener);
