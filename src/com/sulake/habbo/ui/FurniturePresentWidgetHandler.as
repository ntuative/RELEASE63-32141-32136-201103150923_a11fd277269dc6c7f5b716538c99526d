package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      private static const const_1260:String = "poster";
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_878,RoomWidgetPresentOpenMessage.const_161,RoomWidgetPresentOpenedMessage.const_1507];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_878:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     this.var_358 = _loc2_.id;
                     _loc6_ = _loc5_.getString(RoomObjectVariableEnum.const_82);
                     if(_loc6_ == null)
                     {
                        _loc6_ = "";
                     }
            ...
            case RoomWidgetPresentOpenMessage.const_161:
               ...
               if(_loc4_.objectId != this.var_358)
               {
                  return null;
               }
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_81:
                           if(_loc3_ != null && _loc3_.name == const_214)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_547,0,this._container.localization.getKey("inventory.furni.item.floor.name"),false,null);
                           }
                           else if(_loc3_ != null && _loc3_.name == const_100)
                           {
                           ...
                           else if(_loc3_ != null && _loc3_.name == const_213)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_522,0,this._container.localization.getKey("inventory.furni.item.wallpaper.name"),false,null);
                           }
                           else
                           {
                              if(_loc3_ != null && _loc3_.name == const_1260)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_346:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_509,0,this._container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
