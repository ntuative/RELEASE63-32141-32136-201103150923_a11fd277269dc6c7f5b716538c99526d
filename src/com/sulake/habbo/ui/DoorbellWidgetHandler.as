package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetLetUserInMessage.const_741];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_741:
      ...
      {
         return [RoomSessionDoorbellEvent.const_116,RoomSessionDoorbellEvent.const_146,RoomSessionDoorbellEvent.const_47];
      }
