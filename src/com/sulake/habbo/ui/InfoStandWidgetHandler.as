package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_631.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_631.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_772);
         _loc1_.push(RoomWidgetGiveBadgeMessage.GIVE_BADGE);
         _loc1_.push(RoomWidgetFurniActionMessage.const_205);
         _loc1_.push(RoomWidgetFurniActionMessage.const_571);
         _loc1_.push(RoomWidgetFurniActionMessage.const_425);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_639);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_667);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1640);
         _loc1_.push(RoomWidgetPetCommandMessage.const_544);
         ...
         _loc1_.push(RoomWidgetChangeMottoMessage.const_879);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_550)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_381 || param1.type == RoomWidgetUserActionMessage.const_566 || param1.type == RoomWidgetUserActionMessage.const_567)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_740:
               ...
               break;
            case RoomWidgetUserActionMessage.const_772:
            ...
            case RoomWidgetUserActionMessage.const_381:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_639:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_667:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_308);
               _loc6_.id = param1.id;
               ...
               if(_loc8_.getString(RoomWidgetEnum.const_655) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetEnum.const_655);
               }
               ...
               _loc12_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1052);
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc13_.type == RoomObjectTypeEnum.const_176)
               {
               ...
               {
                  if(_loc13_.type != RoomObjectTypeEnum.const_665)
                  {
                     return null;
                  }
                  _loc14_ = "null";
               ...
               if(_loc19_ != null)
               {
                  _loc15_.carryItem = _loc19_.getModel().getNumber(RoomObjectVariableEnum.const_478);
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_112)
               {
                  _loc15_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_137)
               {
                  ...
                  if(_loc19_ != null)
                  {
                     _loc33_ = _loc19_.getModel().getString(RoomObjectVariableEnum.const_651);
                  ...
                  if(!_loc29_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1107;
                  }
                  if(!_loc30_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1128;
                  }
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc16_.push(RoomWidgetUserInfoUpdateEvent.const_1391);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_631.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_631.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_651);
