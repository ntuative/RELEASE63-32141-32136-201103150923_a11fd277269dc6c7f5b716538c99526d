package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFriendRequestMessage.const_676);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_694);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_804:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_676:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_694:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionFriendRequestEvent.const_132);
         _loc1_.push(FriendRequestEvent.const_47);
         _loc1_.push(FriendRequestEvent.const_324);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionFriendRequestEvent.const_132:
            ...
            case FriendRequestEvent.const_324:
