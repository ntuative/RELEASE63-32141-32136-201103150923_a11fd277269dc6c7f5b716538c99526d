package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_777,RoomWidgetEcotronBoxOpenMessage.const_659,RoomWidgetEcotronBoxOpenedMessage.const_1416];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_777:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_659:
