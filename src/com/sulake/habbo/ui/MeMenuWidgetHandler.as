   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_275,this.onFigureUpdate);
            }
            if(this._inventory != null)
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_820,this.onAvatarEffectsChanged);
            ...
            {
               this.var_187.events.removeEventListener(HabboToolbarEvent.const_72,this.onHabboToolbarEvent);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_498,this.onHelpTutorialEvent);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_275,this.onFigureUpdate);
         }
         this._inventory = this._container.inventory;
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_820,this.onAvatarEffectsChanged);
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_498,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1454)
            {
               ...
               this.var_1454 = _loc2_;
               this.var_1860 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1860;
            }
         }
         if(this.var_187 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1183,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_780);
         _loc1_.push(RoomWidgetDanceMessage.const_728);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_808);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_714);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_901);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_727);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_795);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_400);
         _loc1_.push(RoomWidgetStopEffectMessage.const_723);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1533);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1192);
         _loc1_.push(RoomWidgetToolbarMessage.const_656);
         _loc1_.push(RoomWidgetToolbarMessage.const_738);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_335);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1650);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1106);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_683);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_867);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_731);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1510);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_757);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_734);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_892);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_362);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_867:
               ...
               break;
            case RoomWidgetWaveMessage.const_780:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_728:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_808:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_714:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_901:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_400:
               ...
               break;
            case RoomWidgetOpenInventoryMessage.const_795:
               ...
               if(this._inventory != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1197:
                        this._catalog.openCatalogPage(CatalogPageName.const_1541,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1229:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_293);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1500:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_78);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1556:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_727:
            case RoomWidgetStopEffectMessage.const_723:
            ...
            case RoomWidgetToolbarMessage.const_656:
               ...
               break;
            case RoomWidgetToolbarMessage.const_738:
               ...
               {
                  this.var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_469,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_335:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_464));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_731:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_409,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_757:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_409,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_734:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_409,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_892:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_428));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_362:
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_498:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_433));
         }
      }
