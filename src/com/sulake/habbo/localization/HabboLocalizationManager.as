package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      private var var_1853:Dictionary;
      ...
      {
         this.var_1853 = new Dictionary();
         this.var_2593 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_1852 = (param2 & 0) > 0;
         if(!this.var_1852)
         {
            lock();
         }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_1852)
            {
               if("FurnitureAliasesMessageEvent" == this._configuration.getKey("use.default.localizations","FurnitureAliasesMessageEvent"))
               {
      ...
      {
         return this.var_2593[Math.max(0,param1 - 1)];
      }
   }
}
