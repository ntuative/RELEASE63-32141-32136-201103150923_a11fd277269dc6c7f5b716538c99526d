package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1308:String = "pixelbalance";
      
      private static const const_1306:String = "badges";
      
      private static const const_1303:String = "selectbadge";
      
      private static const const_1305:String = "inventory";
      
      private static const const_1309:String = "selectfurni";
      
      private static const const_1310:String = "credits";
      
      private static const const_1307:String = "friendlist";
      
      private static const const_1304:String = "pet_inventory";
      ...
      private var var_490:HabboNotificationViewManager;
      ...
      private var var_901:ClubGiftNotification;
      
      private var var_898:ClubEndingNotification;
      
      private var var_899:ClubPromoNotification;
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_72)
         {
            ...
            this.var_490 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_900["styles"],this.var_900["view"],this.var_735);
            ...
            registerUpdateReceiver(this.var_490,1);
            registerUpdateReceiver(this,2);
            this.var_294.events.addEventListener(BadgeImageReadyEvent.const_142,this.onBadgeImage);
            this.var_735.events.addEventListener(HabboToolbarEvent.const_500,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1381[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_294);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1381[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1381[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1532,null);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_294.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1190,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1190,null);
            }
         }
      }
      ...
      private function onBadgeReceived(param1:BadgeReceivedMessageEvent) : void
      {
         ...
         if(this.var_294.userId == _loc3_)
         {
            ...
            _loc9_ = this.var_294.getBadgeImage(_loc4_);
            this.addItem(!!_loc6_ ? _loc6_.value : "notifications.text.received.badge",NotificationType.const_686,_loc9_,_loc4_);
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1452,null);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_525.createAvatarImage(param2,AvatarScaleType.const_58);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = this.var_294.getFloorItemData(_loc8_.furniClassId);
               }
               else if(_loc8_.productType == CatalogPageMessageProductData.const_81)
               {
                  _loc9_ = this.var_294.getWallItemData(_loc8_.furniClassId);
               }
               _loc5_ = this.getProductImage(_loc8_.productType,_loc8_.furniClassId,_loc8_.extraParam);
            }
            _loc6_ = this.var_294.getProductData(_loc4_.localizationId);
         }
         if(!_loc6_)
         {
            return;
         ...
         if(_loc7_)
         {
            this.addItem(_loc7_.value,NotificationType.const_1656,_loc5_);
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_81:
               ...
               break;
            case CatalogPageMessageProductData.const_236:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1011)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1497,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_899 = new ClubPromoNotification(_loc2_.method_7,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_490.isSpaceAvailable() && this.var_1131.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_490.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      private function onBadgeImage(param1:BadgeImageReadyEvent) : void
      {
         ...
         {
            this.var_490.replaceIcon(param1);
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 3002)
            {
               return FurniCategory.const_401;
            }
            if(param2 == 4057)
            {
               return FurniCategory.const_407;
            }
            return 1;
         }
         return 1;
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1156,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1156,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_525.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_58);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2432)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_686,null);
            this.var_2432 = true;
      ...
      {
         if(param2.type == WindowEvent.const_180 || param2.type == WindowEvent.const_633)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_901 && this.var_901.visible)
         {
            return;
         }
         this.var_901 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_686,_loc6_);
      }
   }
}
