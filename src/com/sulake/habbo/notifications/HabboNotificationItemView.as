package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      private static const const_937:int = 2;
      
      private static const const_936:int = 3;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_1605 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_1605 = 15;
         }
         this.var_1604 = this._window.height;
         this.var_690 = 4;
         this.var_691 = 0;
         this._state = name_2;
         this.var_187 = param5;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_523:
               ...
               _loc2_ = Number(this.var_1076) / Number(this.var_403["time_fade_in"]);
               if(this.var_1076 > int(this.var_403["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_937:
               ...
               if(this.var_1325 > int(this.var_403["time_display"]) && !this.var_1606)
               {
                  this.startFadeOut();
               }
               break;
            case const_936:
               ...
               _loc3_ = 1 - Number(this.var_1077) / Number(this.var_403["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1077 > int(this.var_403["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1605;
         if(this._window.height < this.var_1604)
         {
            this._window.height = this.var_1604;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this.var_187.orientation == "TOP" ? int(const_412) : 0;
         var _loc4_:int = this.var_187.orientation == "BOTTOM" ? int(_loc2_.height - const_412) : int(_loc2_.height);
         var _loc5_:int = this.var_187.orientation == "LEFT" ? int(const_412) : 0;
         var _loc6_:int = this.var_187.orientation == "RIGHT" ? int(_loc2_.width - const_412) : int(_loc2_.width);
         if(this.var_403["position_horizontal_follow_toolbar"] == "true" && (this.var_187.orientation != "TOP" && this.var_187.orientation != "BOTTOM"))
         {
            if(this.var_187.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_451;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_451;
            }
         }
         else if(this.var_403["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_451;
         }
         else
         ...
         if(this.var_403["position_vertical_follow_toolbar"] == "true" && (this.var_187.orientation != "RIGHT" && this.var_187.orientation != "LEFT"))
         {
            if(this.var_187.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_690;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_690;
            }
         }
         else if(this.var_403["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_690;
         }
         else
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_691;
      }
   }
}
