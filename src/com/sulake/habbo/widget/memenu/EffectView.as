package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2030:int = 1000;
      
      private var _container:MeMenuEffectsView;
      
      private var _window:IWindowContainer;
      
      private var var_188:IWidgetAvatarEffect;
      ...
      {
         super();
         this.var_198 = new Timer(this.const_2030);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_188.isActive)
         {
            _loc2_ = this.var_188.secondsLeft / Number(this.var_188.duration);
            this.var_1012.width = _loc2_ * this.var_317;
         }
         else
         {
            this.var_1012.width = 0;
            this.var_198.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_812 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_812 == null)
            {
               return;
            }
         ...
         if(!this.var_188.isActive)
         {
            this.var_812.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_812.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_812.text;
         var _loc2_:int = this.var_188.secondsLeft;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         if(this.var_188.isInUse)
         {
            _loc3_ = "memenu_effect_selected";
         }
         else if(this.var_188.isActive)
         {
         ...
         this.setTimeLeft();
         this.var_1012 = this._window.findChildByName("loader_bar");
         if(this.var_1012 != null)
         {
            this.var_317 = this.var_1012.width;
            this.var_198.start();
            this.onUpdate();
         }
         if(this.var_188.icon)
         {
            this.setElementBitmap("effect_icon",this.var_188.icon);
         }
      }
