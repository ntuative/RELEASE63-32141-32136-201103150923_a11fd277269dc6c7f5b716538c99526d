package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1107:MeMenuSoundSettingsView;
      ...
      public function set min(param1:Number) : void
      {
         ...
         this.setValue(this.var_1107.volume);
      }
      ...
      {
         return param1 / this.var_1654 * (this.var_1183 - this._minValue) + this._minValue;
      }
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1107.saveVolume(this.getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_707 != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_707.width,this.var_707.height,true,16777215);
                  _loc3_.bitmap.copyPixels(this.var_707,this.var_707.rect,new Point(0,0),null,null,true);
                  _loc2_.procedure = this.buttonProcedure;
                  this.var_1654 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
