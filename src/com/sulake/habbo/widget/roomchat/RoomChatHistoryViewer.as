package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1299:int = 18;
      ...
      private var var_181:RoomChatHistoryPulldown;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_702 = false;
         this._widget = param1;
         this.var_181 = new RoomChatHistoryPulldown(param1,param2,param3,param4);
         this.var_181.state = RoomChatHistoryPulldown.const_228;
         ...
         this.var_49 = param2.createWindow("chatscroller","",HabboWindowType.const_1234,HabboWindowStyle.const_43,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_181.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_228);
      }
      ...
      {
         return !!this.var_408 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_181.state == RoomChatHistoryPulldown.const_404 || this.var_181.state == RoomChatHistoryPulldown.const_523;
      }
      ...
      {
         if(!this.var_408 && !this.var_1724)
         {
            this.var_408 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_181.state = RoomChatHistoryPulldown.const_404;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_49 != null)
         {
            ...
            if(param2)
            {
               this.var_49.scrollV = this.var_583;
            }
         }
         if(this.var_181 != null)
         {
            this.var_181.containerResized(param1);
         }
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_409 > 0 && param2)
         {
            if(this.var_1700)
            {
               if(Math.abs(param1 - this.var_409) <= const_1101)
               {
                  return;
               }
               this.var_1700 = false;
            ...
            if(this.var_408)
            {
               ...
               _loc5_ = (param1 - this.var_409) / this.var_49.height;
               _loc3_ = this.var_583 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_409;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_49.scrollV < 1 - const_1299 / this.var_49.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1701)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_49 != null)
         {
            this.var_583 = this.var_49.scrollV;
         }
         if(this.var_49 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_583 - this.var_49.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
