package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1297:int = 11;
      
      private static const const_592:int = 18;
      
      private static const const_943:int = 16;
      
      private static const const_1298:int = 20;
      
      private static const const_1718:int = 32;
      ...
      private var var_317:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager)
      {
         ...
         this.var_1117 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2372 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_345 = new Timer(1000,1);
         this.var_345.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_407 = new Timer(10000,1);
         this.var_407.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_407.reset();
            this.var_407.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_407 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         if(this._configuration.getKey("friendbar.enabled","0") == "1")
         {
         ...
         _loc6_.addEventListener(WindowKeyboardEvent.const_194,this.windowKeyEventProcessor);
         _loc6_.addEventListener(WindowEvent.const_105,this.onInputChanged);
         this._window.addEventListener(WindowEvent.const_385,this.onWindowMoved);
         this.var_1695 = true;
         this.var_484 = "";
         this.refreshView();
      }
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_592 + const_943;
         _loc1_.x = const_592;
         _loc1_.y = const_1297;
      }
      ...
      {
         this.var_317 = param1 - (const_592 + const_943);
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1117 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_484 = "";
               }
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1298);
      }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(!this._widget.allowPaste && _loc2_.text.length > this.var_484.length + 1)
            {
               _loc2_.text = "";
            }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_581);
