package com.sulake.habbo.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2837:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2837 = param1.root.assets;
      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_398:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this.var_79,this.var_157,this.var_2608++,this);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this.var_79,this.var_157,this);
               break;
            case RoomWidgetEnum.const_455:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this.var_79,this.var_157,this._catalog,this.var_509);
               break;
            case RoomWidgetEnum.const_584:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this.var_79,events,this.var_157);
               break;
            ...
            case RoomWidgetEnum.const_434:
               _loc2_ = new TeaserFurniWidget(this._windowManager,assets,this.var_79,this.var_157,this._inventory);
               break;
            ...
            case RoomWidgetEnum.const_490:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this.var_79,this.var_157);
               break;
            case RoomWidgetEnum.const_913:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this.var_79,this.var_157);
               break;
            case RoomWidgetEnum.const_118:
               _loc2_ = new VoteWidget(this._windowManager,assets,this.var_79,this.var_157);
               break;
            ...
            case RoomWidgetEnum.const_562:
               _loc2_ = new WelcomeGiftWidget(this._windowManager,assets,this.var_79);
         }
         return _loc2_;
      }
   }
