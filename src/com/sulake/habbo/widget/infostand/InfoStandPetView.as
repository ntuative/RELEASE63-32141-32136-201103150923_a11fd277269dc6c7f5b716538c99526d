package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_194:IBorderWindow;
      
      private var var_68:IItemListWindow;
      
      private var var_53:IItemListWindow;
      
      private var var_195:PetCommandTool;
      
      private var _petData:Map;
      
      private var var_458:int;
      
      private const const_2009:int = 152;
      
      private const const_2011:int = 16;
      
      private const const_1278:int = 4;
      
      private const const_2008:uint = 14342874;
      
      private const const_2005:uint = 3815994;
      
      private const const_1999:uint = 2085362;
      
      private const const_2010:uint = 39616;
      
      private const const_2003:uint = 10513106;
      
      private const const_2004:uint = 8734654;
      
      private const const_2000:uint = 9094430;
      
      private const const_2001:uint = 6200576;
      
      private const const_2006:String = "happiness";
      
      private const const_2002:String = "experience";
      
      private const const_2007:String = "energy";
      ...
      {
         if(this.var_53 == null || this.var_194 == null || this.var_68 == null)
         {
            return;
         }
         ...
         this.var_194.height = this.var_53.height + 20;
         this._window.width = Math.max(this.var_194.width,this.var_68.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_194.width < this.var_68.width)
         {
            this.var_194.x = this._window.width - this.var_194.width;
            this.var_68.x = 0;
         }
         else
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2006,param1.nutrition,param1.nutritionMax,this.const_2010,this.const_1999);
         this.updateStateElement(this.const_2002,param1.experience,param1.experienceMax,this.const_2004,this.const_2003);
         this.updateStateElement(this.const_2007,param1.energy,param1.energyMax,this.const_2001,this.const_2000);
         ...
         if(this.var_195 && this.var_195.isVisible() && param1.isOwnPet)
         {
            this.var_195.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_195.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2009,this.const_2011,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2008);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2005);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1278,_loc7_.width - 2,_loc7_.height - 2 - this.const_1278);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1278);
      ...
      private function openTrainView() : void
      {
         if(this.var_195 == null)
         {
            this.var_195 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_458) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_195.showWindow(true);
            this.var_195.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_194 = this._window.getListItemByName("info_border") as IBorderWindow;
         if(this.var_194 != null)
         {
            this.var_53 = this.var_194.findChildByName("infostand_element_list") as IItemListWindow;
         }
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_194.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         var _loc7_:IBitmapWrapperWindow = this.var_194.findChildByName("status_happiness_icon") as IBitmapWrapperWindow;
         if(_loc7_ != null)
         {
         ...
         var _loc8_:IBitmapWrapperWindow = this.var_194.findChildByName("status_experience_icon") as IBitmapWrapperWindow;
         if(_loc8_ != null)
         {
         ...
         var _loc9_:IBitmapWrapperWindow = this.var_194.findChildByName("status_energy_icon") as IBitmapWrapperWindow;
         if(_loc9_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_195 && this.var_195.getPetId() == this.var_458)
               {
                  this.var_195.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_548,this._widget.petData.ownerId);
