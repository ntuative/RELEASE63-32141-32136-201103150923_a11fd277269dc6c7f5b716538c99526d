package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1739:String = "infostand_user_view";
      
      private const const_1738:String = "infostand_furni_view";
      
      private const const_1741:String = "infostand_pet_view";
      
      private const const_1737:String = "infostand_bot_view";
      
      private const const_1740:String = "infostand_jukebox_view";
      
      private var var_1247:InfoStandFurniView;
      
      private var var_141:InfoStandUserView;
      
      private var var_382:InfoStandPetView;
      
      private var var_447:InfoStandBotView;
      
      private var var_2766:InfoStandJukeboxView;
      
      private var var_2767:Array;
      
      private var var_1514:InfostandUserData;
      
      private var var_556:InfostandFurniData;
      ...
      private const const_2028:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog, param6:IHabboSoundManager)
      {
         ...
         this.var_509 = param6;
         this.var_1247 = new InfoStandFurniView(this,this.const_1738,this._catalog);
         this.var_141 = new InfoStandUserView(this,this.const_1739);
         this.var_382 = new InfoStandPetView(this,this.const_1741,this._catalog);
         this.var_447 = new InfoStandBotView(this,this.const_1737);
         this.var_2766 = new InfoStandJukeboxView(this,this.const_1740,this._catalog,this.var_509);
         this.var_1514 = new InfostandUserData();
         this.var_556 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_171 = new Timer(this.const_2028);
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            this._mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_63,HabboWindowStyle.const_43,HabboWindowParam.const_43,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_126,this.onClose);
         ...
         param1.addEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_634,this.onUserGivableBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_673,this.onBadgeImage);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_126,this.onClose);
         ...
         param1.removeEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_634,this.onUserGivableBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_673,this.onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_381,this.var_382.getCurrentPetId()));
      }
      
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         this.userData.setData(param1);
         this.var_141.update(param1);
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetEnum.const_1104)
         {
            this.var_2766.update(param1);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         if(param1.isOwnUser)
         {
            this.var_141.setTags(param1.tags);
         }
         else
         {
            this.var_141.setTags(param1.tags,this.var_2767);
         }
      }
      ...
      private function onUserFigureUpdate(param1:RoomWidgetUserFigureUpdateEvent) : void
      {
         ...
         {
            this.var_447.image = param1.image;
         }
         else
         {
            this.var_141.image = param1.image;
            this.var_141.setMotto(param1.customInfo,param1.isOwnUser);
            this.var_141.achievementScore = param1.achievementScore;
         }
      }
      ...
      private function onUserGivableBadges(param1:RoomWidgetUserGivableBadgesUpdateEvent) : void
      {
         ...
         this.var_141.updateGivableBadges();
      }
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(this.userData.isBot())
            {
               this.var_447.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
               this.var_141.setBadgeImage(_loc2_,param1.badgeImage);
            }
            return;
         }
         var _loc4_:* = [];
         ...
         if(_loc4_.length > 0)
         {
            this.var_141.setGivableBadgeImage(_loc4_,param1.badgeImage);
            return;
         }
         if(param1.badgeID == this.userData.groupBadgeId)
         {
            this.var_141.setGroupBadgeImage(param1.badgeImage);
         }
      }
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectUpdateEvent.const_144:
               _loc2_ = param1.id == this.var_556.id;
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_165:
               if(this.var_141 != null && this.var_141.window != null && this.var_141.window.visible)
               {
                  _loc2_ = param1.id == this.var_1514.userRoomId;
                  break;
               }
               ...
               if(this.var_447 != null && this.var_447.window != null && this.var_447.window.visible)
               {
                  _loc2_ = param1.id == this.var_1514.userRoomId;
                  break;
               }
