package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandJukeboxView
   {
      ...
      public function InfoStandJukeboxView(param1:InfostandWidget, param2:String, param3:IHabboCatalog, param4:IHabboSoundManager)
      {
         ...
         this.var_509 = param4;
         this.var_509.events.addEventListener(NowPlayingEvent.const_912,this.onNowPlayingChanged);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_509)
         {
            this.var_509.events.removeEventListener(NowPlayingEvent.const_912,this.onNowPlayingChanged);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_864 = this.var_194.findChildByTag("catalog");
         if(this.var_864 != null)
         {
            this.var_864.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         var _loc2_:int = this.var_509.musicController.getRoomItemPlaylist().nowPlayingSongId;
         if(_loc2_ != -1)
         {
            _loc6_ = this.var_509.musicController.getSongInfo(_loc2_);
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_53.addListItem(this.var_864);
            }
            this.var_864.visible = param1;
         }
         else
         {
            this.var_53.removeListItem(this.var_864);
         }
      }
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this._widget.mainContainer.visible && this._window.visible)
         {
            if(param1.id != -1)
            {
               _loc2_ = this.var_509.musicController.getSongInfo(param1.id);
