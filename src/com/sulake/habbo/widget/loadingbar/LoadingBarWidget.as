package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_536:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_536.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_536 = null;
         }
         if(this.var_46 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_536 == null)
         {
            this.var_536 = new Sprite();
            this.var_536.addChild(new Bitmap(this.var_46));
            this.var_536.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_536.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_46;
            }
         }
         _loc2_.setDisplayObject(this.var_536);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1128 != "")
         {
            HabboWebTools.openWebPage(this.var_1128);
         }
      }
   }
}
