package com.sulake.habbo.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1251:Number = 100;
      
      private static const const_1252:Number = 100;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_443,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_506,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetPetPackageUpdateEvent.const_350,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_443,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_506,this.onObjectUpdate);
         param1.removeEventListener(RoomWidgetPetPackageUpdateEvent.const_350,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPetPackageUpdateEvent) : void
      {
         ...
         switch(event.type)
         {
            case RoomWidgetPetPackageUpdateEvent.const_443:
               this.hideInterface();
               this.var_358 = event.objectId;
               this.var_560 = event.image;
               this.showInterface();
               this.showPetImage();
               break;
            case RoomWidgetPetPackageUpdateEvent.const_506:
               if(!this.var_1054)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPetPackageUpdateEvent.const_350:
               if(event.objectId != this.var_358)
               {
                  return;
               }
               this.var_560 = event.image;
      ...
      private function showInterface() : void
      {
         ...
         this._window.x = const_1251;
         this._window.y = const_1252;
      ...
      {
         var _loc2_:* = null;
         if(this.var_560 == null || this._window == null)
         {
            return;
         }
         ...
         if(_loc1_ != null)
         {
            ...
            _loc2_ = new Point((_loc1_.width - this.var_560.width) / 2,(_loc1_.height - this.var_560.height) / 2);
            _loc1_.bitmap.copyPixels(this.var_560,this.var_560.rect,_loc2_);
         }
      }
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1054 || this.var_358 == -1)
         {
            return;
         }
         ...
         {
            this.var_1054 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_705,this.var_358,name);
