package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_589:String = "welcome_gift_email_unverified";
      
      private const const_935:String = "welcome_gift_email_verified";
      
      private const const_1263:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1072)
         {
            this.setViewState(this.const_935);
         }
         else
         {
            this.setViewState(this.const_589);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_589:
               ...
               this.var_16.findChildByName("edit").visible = this.var_2212;
               break;
            case this.const_935:
      ...
      {
         this.setViewState(this.const_1263);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_664,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1072 ? this.const_935 : this.const_589);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1071 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1071));
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_580:
               this.var_1071 = param1.email;
               this.var_1072 = param1.isVerified;
               this.var_2212 = param1.allowEmailChange;
