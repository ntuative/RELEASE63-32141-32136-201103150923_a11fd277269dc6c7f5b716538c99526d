package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1301:int = 10;
      
      private static const const_944:int = 100;
      
      private static const const_1302:int = 20;
       
      
      private var var_140:HabboMessenger;
      
      private var var_2430:IScrollbarWindow;
      
      private var var_1721:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_140 = param1;
         this.var_1721 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_63 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2430 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_944 + const_1302)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1301;
         param1.invalidate();
      }
      ...
      public function refreshHeader() : void
      {
         ...
         {
            this.var_1721.enable();
         }
         else
         {
            this.var_1721.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_63.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_489.messages.length - const_944);
         _loc1_ = 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_838 || param3.type == Message.const_697 ? param3.time + ": " : "";
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_140.send(new FollowFriendMessageComposer(this.var_489.id));
      }
