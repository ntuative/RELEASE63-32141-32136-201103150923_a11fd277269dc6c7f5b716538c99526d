package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1762:IWindowContainer;
      ...
      private var var_2480:ITextWindow;
      
      private var var_2479:ITextWindow;
      ...
      {
         this.var_355 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_355));
      ...
      {
         if(param1 != this.var_355 || this.var_1154 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1154 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1558)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1605)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1559)
         {
            this.var_911.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_499,this.onDoorModePasswordSelect);
         ...
         this.var_910 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_911 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1147 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1153 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         ...
         this.var_1761 = IWindowContainer(this._window.findChildByName("header_container"));
         ...
         this.var_1152 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1762 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1398 = IWindowContainer(this._window.findChildByName("footer_container"));
         ...
         this.var_2480 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2479 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1396 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1396.mouseThreshold = 0;
         this.var_1396.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1146.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1761.visible = this._inRoom;
         this.var_1762.visible = this._inRoom;
         this.var_2479.visible = this.var_505;
         this.var_2480.visible = !this.var_505;
         if(this.var_505)
         {
            this.var_1152.visible = true;
            this.var_1398.visible = false;
            this.refreshFlatControllers();
            this.var_1152.height = Util.getLowestPoint(this.var_1152) + 4;
         }
         else
         {
            this.populateForm();
            this.var_1149.visible = true;
            this.var_1398.visible = true;
         ...
         this.var_1396.text = !!this.var_505 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1761.name,this.var_1397.name,this.var_1149.name,this.var_1152.name,this.var_1398.name,this.var_1762.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.setTag(this.var_910,_loc1_.tags[1]);
         if(this.var_1153)
         {
            if(_loc1_.allowPets)
            {
               this.var_1153.select();
            }
            else
            {
               this.var_1153.unselect();
            }
         }
         if(this.var_1150)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.allowPets = this.var_1153.isSelected;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_355);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_77.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_355]);
         _loc2_.show();
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_259.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_259.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_259.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_259.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_259.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_259.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_259.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_259);
         this.var_259.findChildByName("ruler").visible = true;
         ...
         if(this.var_77.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_259,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_63,HabboWindowStyle.const_31,HabboWindowParam.const_60,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_355));
      }
