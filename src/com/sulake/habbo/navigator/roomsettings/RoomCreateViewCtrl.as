package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private function updateArrowPos(param1:Event) : void
      {
         ...
         _loc3_.y += !!this.var_1838 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1838 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_184 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_63 = IItemListWindow(this.var_184.findChildByName("item_list"));
         ...
         var _loc3_:IWindow = this.var_184.findChildByTag("close");
         this.addMouseClickListener(_loc3_,this.onCancelButtonClick);
         this.var_1192 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_184.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_184.desktop,this.var_184.width,this.var_184.height);
         this.var_184.x = _loc4_.x;
         this.var_184.y = _loc4_.y;
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_63,HabboWindowStyle.const_31,HabboWindowParam.const_60,new Rectangle(0,0,100,300)));
      }
      ...
      {
         return IButtonWindow(this.var_184.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_184.findChildByName("back_button"));
      }
