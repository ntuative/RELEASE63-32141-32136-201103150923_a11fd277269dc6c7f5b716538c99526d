package com.sulake.habbo.navigator
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      protected var var_277:IFrameWindow;
      ...
      {
         var _loc1_:AlertView = var_628[this.var_1025] as AlertView;
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
         this.var_277 = this.getAlertWindow();
         if(this._title != null)
         {
            this.var_277.caption = this._title;
         }
         this.setupAlertWindow(this.var_277);
         var _loc2_:Rectangle = Util.getLocationRelativeTo(this.var_277.desktop,this.var_277.width,this.var_277.height);
         this.var_277.x = _loc2_.x;
         this.var_277.y = _loc2_.y;
         var_628[this.var_1025] = this;
         this.var_277.activate();
      }
      ...
      {
         var _loc1_:IFrameWindow = this._navigator.getXmlWindow(this.var_1025,2) as IFrameWindow;
