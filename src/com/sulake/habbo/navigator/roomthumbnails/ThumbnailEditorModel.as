package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailEditorModel
   {
      ...
      private var var_205:RoomThumbnailObjectData;
      ...
      private function removeSelected() : void
      {
         ...
         var _loc2_:int = Util.remove(_loc1_,this.var_205);
         this.var_205 = null;
         if(_loc1_.length > 0)
         {
            this.var_205 = _loc1_[Math.min(_loc2_,_loc1_.length - 1)];
         }
      }
      ...
      {
         this.var_205 = this.findByPos(param1);
         if(this.var_205 == null)
         {
      ...
      {
         if(this.var_638 == const_39)
         {
            this._data.bgImgId = param1;
         }
         else if(this.var_638 == const_61)
         {
            this._data.frontImgId = param1;
         }
         if(this.var_638 == const_35)
         {
            if(this.var_205 == null)
            {
               return;
            }
            this.var_205.imgId = param1;
         }
      }
      ...
      public function getImgId() : int
      {
         ...
         if(this.var_638 == const_61)
         {
            return this._data.frontImgId;
         }
         return this.var_205 == null ? -1 : int(this.var_205.imgId);
      }
      ...
      {
         this._data = param1;
         this.var_638 = const_39;
         if(this._data.objects.length > 0)
         {
            this.var_205 = this._data.objects[0];
         }
         else
         {
            this.var_205 = null;
