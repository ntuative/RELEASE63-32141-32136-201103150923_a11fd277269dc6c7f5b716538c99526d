package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      private var var_1941:BitmapData;
      
      private var var_648:IBitmapWrapperWindow;
      
      private var var_1944:Rectangle;
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_1942 = this._navigator.getButtonImage(this.var_1943);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_1944 == null)
         {
            ...
            this.var_1944 = new Rectangle(this.var_1497,this.var_1497,_loc1_.width - 2 * this.var_1497,_loc1_.height - 2 * this.var_1497);
         }
         this.var_648.bitmap.fillRect(this.var_648.bitmap.rect,4281545523);
         this.var_648.bitmap.fillRect(this.var_1944,4284900966);
         this.copyTo(this.var_648.bitmap);
         if(this.var_205)
         {
            this.var_648.bitmap.copyPixels(this.var_1941,this.var_1941.rect,new Point(0,0),null,null,true);
         }
