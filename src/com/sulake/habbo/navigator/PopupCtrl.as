package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_431)
         {
            this.var_431.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_431.reset();
            this.var_431 = null;
         }
         if(this.var_369)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_57 == null)
         {
            this.var_57 = IWindowContainer(this._navigator.getXmlWindow(this.var_1025));
            this.var_57.visible = false;
            this.var_57.setParamFlag(HabboWindowParam.const_40,true);
         ...
         this.var_57.x = _loc2_.x + this.var_2369 + param1.width;
