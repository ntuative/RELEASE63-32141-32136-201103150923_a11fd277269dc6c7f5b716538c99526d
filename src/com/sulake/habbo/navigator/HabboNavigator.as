package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_309:MainViewCtrl;
      
      private var var_641:RoomInfoViewCtrl;
      
      private var var_1219:RoomCreateViewCtrl;
      ...
      private var var_2228:RoomThumbnailRenderer;
      
      private var var_911:GuestRoomPasswordInput;
      
      private var var_303:GuestRoomDoorbell;
      
      private var var_1218:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2672 = new Array();
         ...
         this.var_309 = new MainViewCtrl(this);
         this.var_641 = new RoomInfoViewCtrl(this);
         this.var_1219 = new RoomCreateViewCtrl(this);
         this.var_2228 = new RoomThumbnailRenderer(this);
         this.var_911 = new GuestRoomPasswordInput(this);
         this.var_303 = new GuestRoomDoorbell(this);
         this.var_402 = new Tabs(this);
         this.var_1218 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_301,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_641.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_129,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this.var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_129,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      {
         var _loc1_:Boolean = this.var_309.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_309.startSearch(Tabs.const_267,Tabs.const_375,param1);
         this.var_309.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_309.startSearch(Tabs.const_299,Tabs.const_241);
         this.var_402.getTab(Tabs.const_299).tabPageDecorator.tabSelected();
      }
