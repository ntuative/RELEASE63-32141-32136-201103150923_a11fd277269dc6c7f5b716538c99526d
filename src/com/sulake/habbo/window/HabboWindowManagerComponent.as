package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_416:uint = 3;
      
      private static const const_1317:uint = 1;
      ...
      private var var_918:IWindowRenderer;
      
      private var var_917:ISkinContainer;
      
      private var var_261:Array;
      
      private var var_1403:IEventDispatcher;
      
      private var var_1159:Boolean = false;
      
      private var var_1764:ProfilerOutput;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_917 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_918 = new WindowRenderer(this.var_917);
         this._windowContextArray = new Array(const_416);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_416)
         {
            this._windowContextArray[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_918,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_270 = this._windowContextArray[const_1317];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1764)
            {
               this.var_1764 = new ProfilerOutput(context,this,this.var_918);
            }
            this.var_1764.profiler = _loc3_;
            this.var_1402 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1402);
      ...
      {
         var _loc3_:Dictionary = this.var_261[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_261[0][param1] as XML : _loc4_;
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return this.var_917.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this._windowContextArray[param1].getDesktopWindow().getChildAt(this.var_270.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1403.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_416 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1403.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_416)
         {
         ...
         this.var_1403.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1421,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1529,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1464,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1456,param2.name + ": " + param2.toString());
            }
         }
      }
