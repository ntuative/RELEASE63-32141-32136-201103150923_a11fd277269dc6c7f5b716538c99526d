package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         this.var_216 = new Array(param1.length);
         var _loc3_:int = 0;
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_897 >= 0 && this._parts.length > this.var_897)
         {
            _loc2_ = this._parts[this.var_897];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function selectColorIndex(param1:int, param2:int) : AvatarEditorGridColorItem
      {
         ...
         this.deselectColorIndex(this.var_216[param2],param2);
         this.var_216[param2] = param1;
      ...
      public function getSelectedColorIds() : Array
      {
         var _loc7_:* = null;
         var _loc8_:* = null;
         if(!this.var_216 || this.var_216.length == 0)
         {
            return null;
         }
         ...
         while(_loc5_ < this.var_216.length)
         {
            ...
            {
               if(_loc7_.length > this.var_216[_loc5_])
               {
                  _loc8_ = _loc7_[this.var_216[_loc5_]] as AvatarEditorGridColorItem;
      ...
      private function getSelectedColors() : Array
      {
         ...
         var _loc3_:int = 0;
         while(_loc3_ < this.var_216.length)
         {
      ...
      public function getSelectedColor(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(!_loc2_ || _loc2_.length <= this.var_216[param1])
         {
            return null;
         }
         return _loc2_[this.var_216[param1]] as AvatarEditorGridColorItem;
      }
      ...
      {
         return this._parts[this.var_897] as AvatarEditorGridPartItem;
      }
