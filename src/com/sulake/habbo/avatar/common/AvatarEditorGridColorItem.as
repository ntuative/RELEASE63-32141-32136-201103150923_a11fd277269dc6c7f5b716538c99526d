package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_1003:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_570.width,this.var_570.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_570,this.var_570.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_881.width,this.var_881.height,true,0);
            _loc5_ = this.var_881.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_1003.colorTransform);
         ...
         if(_loc4_)
         {
            if(this.var_1003)
            {
               switch(this.var_1003.clubLevel)
               {
                  case HabboClubLevelEnum.const_53:
                     _loc4_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_42:
                     _loc4_.style = HabboIconType.const_751;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_44:
                     _loc4_.style = HabboIconType.const_647;
                     _loc4_.visible = true;
               }
            }
            else
