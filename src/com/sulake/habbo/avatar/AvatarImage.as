package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1362:String = AvatarSetType.const_36;
      ...
      protected var var_1833:int;
      
      protected var var_279:IActiveActionData;
      
      protected var var_702:Boolean;
      
      protected var var_789:Array;
      ...
      protected var var_323:Array;
      
      protected var var_46:BitmapData;
      
      private var var_971:IActiveActionData;
      ...
      private var var_2601:String = null;
      
      private var var_2600:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1362,const_1363);
         this.var_323 = new Array();
         this.var_971 = new ActiveActionData(AvatarAction.const_388);
         this.var_971.definition = this._structure.getActionDefinition(const_1361);
         this.resetActions();
      ...
      {
         param2 += this.var_1856;
         if(param2 < AvatarDirectionAngle.const_1228)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_632,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_264.length == 1 && this.var_89 == this.var_1833)
         {
            return this.var_89 + this.var_516 + this.var_632 % 4;
         }
         if(this.var_264.length == 2)
         {
            for each(_loc1_ in this.var_264)
            {
               ...
               {
                  return this.var_89 + this.var_516 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_632 % 11;
                  return this.var_89 + "_" + this.var_1833 + this.var_516 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2602 || param2 != this.var_2601 || param1 != this.var_2600)
         {
            this.var_2602 = param3;
            this.var_2601 = param2;
            this.var_2600 = param1;
            this.var_1855 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_279.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1269 || this.var_46 == null || (this.var_46.width != _loc5_.width || this.var_46.height != _loc5_.height))
         {
            if(this.var_46 != null && !this.var_1269)
            {
               this.var_46.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_279.definition.geometryType,this.var_89);
         this.var_46.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_632);
         ...
         if(this.var_542 != null)
         {
            if(this.var_542.paletteIsGrayscale)
            {
               ...
               this.var_46 = _loc13_;
               this.var_46.paletteMap(this.var_46,this.var_46.rect,new Point(0,0),this.var_542.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_279.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_279.definition.geometryType,this.var_89);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_632);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_323.length)
         {
            _loc3_ = this.var_323[_loc4_];
         ...
         this.var_323.push(new ActiveActionData(param1,param2,this.var_632));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_279 = this.var_971;
         this.var_279.definition = this.var_971.definition;
         this.resetBodyPartCache(this.var_971);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_516 = "";
         this.var_264 = this._structure.sortActions(this.var_323);
         if(this.var_264 == null)
         {
            this.var_789 = new Array(0,0,0);
            if(this.var_1450 != "")
            {
               _loc1_ = true;
               this.var_1450 = "";
         ...
         {
            this.var_789 = this._structure.getCanvasOffsets(this.var_264,this._scale,this.var_89);
            ...
            if(this.var_1450 != this.var_516)
            {
               _loc1_ = true;
               this.var_1450 = this.var_516;
            }
         }
         this.var_1449 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_264)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_972 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1856 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_291 || _loc1_.actionType == AvatarAction.const_253 || _loc1_.actionType == AvatarAction.const_402)
               {
                  this.var_972 = true;
               }
            }
