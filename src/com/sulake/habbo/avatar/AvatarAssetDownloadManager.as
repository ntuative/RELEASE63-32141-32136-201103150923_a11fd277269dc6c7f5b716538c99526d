package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private const const_2022:int = 100;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         this.var_981 = new Timer(this.const_2022,1);
         this.var_981.addEventListener(TimerEvent.TIMER_COMPLETE,this.onNextDownloadTimeout);
      }
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_434)
         {
            this.var_434.addEventListener(AssetLoaderEvent.const_28,this.onConfigurationComplete);
            this.var_434.addEventListener(AssetLoaderEvent.const_48,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_434)
         {
            this.var_434.removeEventListener(AssetLoaderEvent.const_28,this.onConfigurationComplete);
            this.var_434.removeEventListener(AssetLoaderEvent.const_48,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         else
         {
            ...
            if(this.var_1472.indexOf("?") > 0)
            {
               _loc2_ = this.var_1472 + "&retry=" + this.var_982;
            }
            else
            {
               _loc2_ = this.var_1472 + "?retry=" + this.var_982;
      ...
      private function loadFigureMapData(param1:XML) : void
      {
         ...
         this.var_1892 = true;
         for each(_loc2_ in this.var_1215)
         {
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2650,this._assets);
      ...
      public function loadFigureSetData(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1892)
         {
            this.var_1215.push([param1,param2]);
            return;
         }
         ...
         if(_loc4_.length > 0)
         {
            ...
            {
               _loc6_ = this.var_533[_loc3_];
               if(_loc6_ == null)
               {
                  _loc6_ = [];
               }
               _loc6_.push(param2);
               this.var_533[_loc3_] = _loc6_;
            }
            this.var_980[_loc3_] = _loc4_;
      ...
      private function libraryComplete(param1:Event) : void
      {
         ...
         for(_loc3_ in this.var_980)
         {
            ...
            if(_loc7_)
            {
               ...
               delete this.var_533[_loc3_];
            }
         }
         for each(_loc3_ in _loc2_)
         {
            delete this.var_980[_loc3_];
         }
      ...
      {
         var _loc1_:* = null;
         while(this.var_781.length > 0 && this.var_780.length < this.const_1550)
         {
