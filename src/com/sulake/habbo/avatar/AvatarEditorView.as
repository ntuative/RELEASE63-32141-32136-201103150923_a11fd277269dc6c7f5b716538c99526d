package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1255:IWindowContainer;
      
      public static var var_1517:IWindowContainer;
      
      public static var var_1988:int = 6710886;
      ...
      private var var_520:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_519:IFrameWindow;
      ...
      private var var_2615:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1203 = [];
         this.var_1322 = [AvatarEditorFigureCategory.const_774,AvatarEditorFigureCategory.const_52,AvatarEditorFigureCategory.const_273,AvatarEditorFigureCategory.const_644,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_104];
         super();
         ...
         if(var_1255 == null)
         {
            ...
            var_1255 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1517 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1517 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_433 = new Timer(1000);
         this.var_433.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1322;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1322);
         }
         if(param1.length != this.var_1203.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1203.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2617 = this.canChangeOutfit();
            this.var_433.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_520 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_520.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_520.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1203.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_520.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_520.numSelectables)
               {
                  this.var_520.getSelectableAt(_loc6_).x = this.var_520.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1322;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_42) && (this.var_1875 == AvatarEditorSideCategory.const_104 || this.var_2615))
         {
         ...
         this.setViewToCategory(this.var_338);
      }
      ...
      {
         if(this.var_1875 == AvatarEditorSideCategory.const_104)
         {
            this.var_2615 = false;
            this.setSideContent(AvatarEditorSideCategory.const_815);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_815:
               break;
            case AvatarEditorSideCategory.const_573:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_573);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_338 = param1;
         this.var_520.setSelected(this.var_520.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_519)
         {
            ...
            this.var_519 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_519.procedure = this.stripClubDialogEventProc;
            this.var_519.center();
         }
         else
         {
