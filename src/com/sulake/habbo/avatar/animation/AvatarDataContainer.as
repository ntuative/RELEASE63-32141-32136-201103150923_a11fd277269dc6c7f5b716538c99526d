package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_1835 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2561 = parseInt(_loc2_,16);
         this.var_2562 = parseInt(_loc3_,16);
         ...
         this.var_1781 = new ColorTransform(this.var_1688,this.var_1692,this.var_1691,this._alphaMultiplier);
         this.var_1190 = this.generatePaletteMapForGrayscale(this.var_2562,this.var_2561);
      }
