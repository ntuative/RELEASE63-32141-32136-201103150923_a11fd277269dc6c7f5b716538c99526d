package com.sulake.habbo.sound.music
{
   ...
   public class RoomItemPlayListController implements IPlayListController, IDisposable
   {
      ...
      public function RoomItemPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_882,this.onSongFinishedPlayingEvent);
         this.var_81.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_657,this.onSoundMachinePlayEvent);
         this.var_81.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_902,this.onSoundMachineStopEvent);
         this.var_81.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_650,this.onJukeboxStopEvent);
         this.var_81.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_520,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_882,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_81)
            {
               this.var_81.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_657,this.onSoundMachinePlayEvent);
               this.var_81.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_902,this.onSoundMachineStopEvent);
               this.var_81.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_650,this.onJukeboxStopEvent);
               this.var_81.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_520,this.onDisposeEvent);
               this.var_81 = null;
            }
            this._disposed = true;
         }
      ...
      public function startPlaying() : void
      {
         ...
         if(this.var_97 == null || this.var_97.length == 0)
         {
      ...
      {
         var _loc2_:* = null;
         if(this.var_371 == param1)
         {
            this.playCurrentSongAndNotify(this.var_371);
            _loc2_ = this.getNextEntry();
            if(_loc2_ != null)
            {
               this.var_506.requestSongInfo(_loc2_.id);
            }
         }
      }
      ...
      {
         this.var_506.stop(HabboMusicPrioritiesEnum.PRIORITY_ROOM_PLAYLIST);
         this.var_371 = -1;
         this.var_772 = false;
      }
      ...
      {
         var _loc2_:IHabboSound = this.var_506.getSongObject(this.var_371);
         if(_loc2_ != null)
         {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_506.playSong(param1,this.priority,_loc3_))
         {
      ...
      private function getNextEntry() : SongDataEntry
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(_loc3_ < this.var_97.length)
         {
            _loc2_ = this.var_97[_loc3_];
            if(_loc2_.id == this.var_371)
            {
               _loc1_ = _loc3_ + 1;
            }
            _loc3_++;
         }
         if(_loc1_ >= this.var_97.length)
         {
            _loc1_ = 0;
         }
         return this.var_97[_loc1_];
      }
      ...
      private function onPlayListSongAddedMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_97.push(_loc4_);
         if(this.var_97.length == 1)
         {
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_.current >= 0)
         {
            this.var_506.playSong(_loc3_.current,this.priority,_loc3_.syncCount / 1000);
            this.var_371 = _loc3_.current;
         }
         if(_loc3_.next >= 0)
         {
            this.var_506.requestSongInfo(_loc3_.next);
         }
         this.var_772 = true;
         this.var_509.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_912,_loc3_.current));
