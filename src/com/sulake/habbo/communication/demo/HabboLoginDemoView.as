package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_554:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_149.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_141,HabboWindowStyle.const_43,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1698,"/");
         if(_loc5_ != null)
         {
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_149.habboConfiguration.getKey("use.sso","FurnitureAliasesMessageEvent") == "true")
               {
                  _loc8_.select();
               }
            }
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1698,"/");
         ...
         {
            dispatchEvent(new Event(const_554));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_125.removeEventListener(SSOTicket.const_395,this.onParsedTicketSuccess);
            this.var_125.removeEventListener(SSOTicket.const_298,this.onParsedTicketFailure);
            this.var_125 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_125 = new SSOTicket(this.var_149.assets,_loc3_,_loc2_,param1);
         this.var_125.addEventListener(SSOTicket.const_395,this.onParsedTicketSuccess);
         this.var_125.addEventListener(SSOTicket.const_298,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_149.shockwaveClientUrl = this.var_125.shockwaveClientUrl;
         this.var_149.ssoTicket = this.var_125.ticket;
         this.var_125.removeEventListener(SSOTicket.const_395,this.onParsedTicketSuccess);
         this.var_125.removeEventListener(SSOTicket.const_298,this.onParsedTicketFailure);
         this.var_125 = null;
         dispatchEvent(new Event(const_554));
