package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_473:IKeyExchange;
      
      private var var_883:String;
      
      private var var_16:HabboLoginDemoView;
      
      private var var_2310:PseudoRandom;
      ...
      private var var_213:HabboHotelView;
      
      private var var_1349:String = "";
      
      private const const_1698:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_571 = param1;
            this.var_55.initConnection(HabboConnectionType.const_220);
         }
      }
      ...
      {
         if(this.var_55 && this.var_157 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_213 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         var _loc1_:String = this.var_157.getKey("client.hotel_view.image");
         var _loc2_:String = this.var_157.getKey("image.library.url");
         if(_loc1_ != null && _loc2_ != null)
         {
            this.var_213.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_157.getKey("use.sso.ticket") == "1";
         this.var_571 = this.var_157.getKey("sso.ticket",null);
         this.var_1651 = this.var_157.getKey("flash.client.url","");
         this.var_2309 = this.var_157.getKey("external.variables.txt","");
         if(this.var_213 == null)
         {
            this.var_213 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_55.mode = HabboConnectionType.const_88;
            if(this.var_571)
            {
               this.var_55.initConnection(HabboConnectionType.const_220);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this.var_16.addEventListener(HabboLoginDemoView.const_554,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         {
            this.var_55.mode = HabboConnectionType.const_88;
            if(this.var_157.keyExists("local.environment"))
            {
               this.var_55.mode = HabboConnectionType.const_1226;
            }
         }
         this.var_55.initConnection(HabboConnectionType.const_220);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_900);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2310 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_55.mode)
         {
            case HabboConnectionType.const_88:
               _loc6_ = "";
               _loc6_ = this.var_157.getKey("url.prefix",_loc6_);
               _loc6_ = _loc6_.replace("http://","");
               _loc6_ = _loc6_.replace("https://","");
               _loc7_ = this.var_157.getKey("hotelview.banner.url","http:/\nsitename$/gamedata/banner");
               _loc7_ = _loc7_.replace("$sitename$",_loc6_);
               this.var_1349 = _loc4_;
               this.var_213.loadBannerImage(_loc7_ + "?token=" + this.var_1349,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1226:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1542:
               this.var_883 = this.generateRandomHexString(30);
               this.var_473 = new DiffieHellman(new BigInteger(this.var_157.getKey("connection.development.prime"),16),new BigInteger(this.var_157.getKey("connection.development.generator"),16));
               this.var_473.init(this.var_883);
               _loc8_ = this.var_473.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_473.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_473.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2310);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1651,this.var_2309));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1698,"/");
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_265);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2311)
         {
            _loc2_ = this.var_157.getKey("logout.disconnect.url");
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         this.var_2311 = true;
         var _loc2_:String = this.var_157.getKey("logout.url");
         if(_loc2_.length > 0)
         {
      ...
      private function setOriginProperty(param1:String) : String
      {
         ...
         {
            return param1.replace("%origin%",this.var_157.getKey("flash.client.origin","popup"));
         }
         return param1;
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         this.var_473 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_473.init(_loc14_);
            _loc15_ = this.var_473.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_883 = _loc14_;
            }
