package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_1982:int = 2500;
      ...
      {
         if(this._state == RoomSessionEvent.const_226 && this._connection != null)
         {
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1291));
         this.var_1290.add(this.var_1291,getTimer());
         ++this.var_1291;
      }
      ...
      public function receivedChatWithTrackingId(param1:int) : void
      {
         ...
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_1982)
            {
