package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1865)
         {
            this.gotoRoom(this.var_2610,this.var_2611,this.var_1866);
            this.var_1865 = false;
            this.var_1866 = "";
         }
      }
      ...
      public function gotoRoom(param1:Boolean, param2:int, param3:String = "", param4:String = "") : Boolean
      {
         ...
         events.dispatchEvent(new RoomSessionEvent(RoomSessionEvent.const_226,_loc7_));
         return true;
      }
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_1030:
                  break;
               case RoomSessionHandler.const_1074:
                  break;
               case RoomSessionHandler.const_844:
