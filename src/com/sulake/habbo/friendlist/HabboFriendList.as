package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_1029:IAvatarRenderManager;
      
      private var var_668:ISessionDataManager;
      
      private var var_2049:FriendListLookAndFeel;
      
      private var var_402:FriendListTabs;
      
      private var var_16:FriendListView;
      
      private var var_1529:OpenedToWebPopup;
      
      private var var_2048:int;
      
      var var_99:FriendCategories;
      
      private var var_328:FriendRequests;
      
      private var var_1530:AvatarSearchResults;
      ...
      {
         this.var_2049 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_99 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1530 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_547.stop();
            this.var_547.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_547 = null;
         }
         ...
         if(this.var_1029)
         {
            this.var_1029.release(new IIDAvatarRenderManager());
            this.var_1029 = null;
         }
         if(this.var_916)
         {
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1529 = new OpenedToWebPopup(this);
         }
         this.var_1529.show(x,y);
      }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return this.var_99.findFriend(param1);
      }
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_99.getFriendCount(param1,param2);
      }
      
      public function refreshToolBarIcon() : void
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_90,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(this.var_328.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_301,HabboWindowStyle.const_43,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1029.createAvatarImage(param1,AvatarScaleType.const_91,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1029 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_916 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_328 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_99.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_99.addCategory(new FriendCategory(FriendCategory.const_1217,this.getText("friendlist.friends")));
         this.var_99.addCategory(new FriendCategory(FriendCategory.const_399,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_99.addFriend(new Friend(_loc4_));
         }
         this.var_402 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_547)
         {
            this.var_547 = new Timer(120000);
            this.var_547.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_547.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_129,HabboToolbarIconEnum.FRIENDLIST));
         this.var_187.events.addEventListener(HabboToolbarEvent.const_37,this.onHabboToolbarEvent);
         if(this.var_99.getFriendCount(true,false) == 0)
         {
            _loc5_ = this.var_99.findCategory(FriendCategory.const_399);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this.var_16.openFriendList();
            _loc1_ = this.var_402.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_396));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_328.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_328.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_402.findTab(FriendListTab.const_98).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_328.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_402.findTab(FriendListTab.const_98);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1530.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         this.var_99.onFriendListUpdate(param1);
      ...
      public function getFriendNames() : Array
      {
         ...
         return this.var_99.getFriendNames();
      }
      
      public function acceptFriendRequest(param1:int) : void
      {
         var _loc2_:FriendListTab = this.var_402.findTab(FriendListTab.const_98);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_668 || !this.var_328)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_668.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_44))
         {
            _loc2_ = this.var_328.vipLimit;
         }
         else if(this.var_668.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_42))
         {
            _loc2_ = this.var_328.clubLimit;
         }
         if(_loc2_ > this.var_328.limit)
         {
            this.var_328.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(disposed || this.var_99 == null)
         {
            return;
         }
         var _loc2_:Dictionary = this.var_99.getAllFriends();
         if(_loc2_ == null)
         {
            return;
         }
