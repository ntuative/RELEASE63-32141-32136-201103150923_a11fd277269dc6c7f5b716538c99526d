package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1733:String = "noconvinfo";
      
      private static const const_1734:String = "messageinput";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_1443:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1443 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_1001 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_260 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1443.prepare(this.var_1001);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_1212,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_1017,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_807,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_677,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_807,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_677,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1442 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1442.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1845 == -1 ? 0 : int(this.var_17.height - this.var_1845);
         var _loc4_:int = this.var_1844 == -1 ? 0 : int(this.var_17.width - this.var_1844);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_260.y = Util.getLowestPoint(this.var_17.content);
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1178,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_807,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1212,false);
         ...
         this.var_1845 = this.var_17.height;
         this.var_1844 = this.var_17.width;
