package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1873:int = "F".charCodeAt(0);
      
      public static const const_1845:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_746 = param1.online;
         this.var_1670 = param1.followingAllowed && param1.online;
         this._figure = param1.figure;
         this.var_1748 = param1.motto;
         this.var_1747 = param1.lastAccess;
         this.var_1352 = param1.categoryId;
         this.var_1746 = param1.realName;
