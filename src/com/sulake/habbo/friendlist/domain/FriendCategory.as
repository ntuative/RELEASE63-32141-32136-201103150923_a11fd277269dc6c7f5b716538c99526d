package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_210.length / const_353);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_847 * const_353;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_847 + 1) * const_353,this.var_210.length);
      }
