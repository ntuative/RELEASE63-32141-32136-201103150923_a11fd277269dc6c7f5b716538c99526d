package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private var var_335:PetsGridItem;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_335);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_564.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         if(this.var_564 == null || this.var_564.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_564.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_564.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            ...
            this.var_564.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_335.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_64)
         {
            ...
            {
               case "tab_floor":
                  this.var_69.switchCategory(FurniModel.const_45);
                  break;
               case "tab_wall":
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_335 != null)
         {
            this.var_335.setSelected(false);
         }
         this.var_335 = param1;
         if(this.var_335 != null)
         {
            this.var_335.setSelected(true);
         }
