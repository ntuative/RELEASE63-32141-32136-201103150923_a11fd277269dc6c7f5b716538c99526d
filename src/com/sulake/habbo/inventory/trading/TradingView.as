package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_942:uint = 4284532064;
      
      private static const const_941:uint = 2577770;
      ...
      private var var_404:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_404 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1662 = this.createMinimizedWindow();
         }
         if(!this.var_2330)
         {
            return this.var_71;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_71)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.ownUserAccepts ? uint(const_942) : uint(const_941);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_21.otherUserAccepts ? uint(const_942) : uint(const_941);
            }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_1209)
            {
            ...
            this.var_404.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_510);
            this.var_404.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_404.hideDelayed();
         }
      }
