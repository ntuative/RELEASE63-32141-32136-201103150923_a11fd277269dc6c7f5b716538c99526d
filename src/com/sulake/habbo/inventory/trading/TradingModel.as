package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1626:uint = 9;
      
      public static const const_195:uint = 0;
      
      public static const const_202:uint = 1;
      
      public static const const_360:uint = 2;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_56.updateItemList(this.var_704);
         this.var_56.updateItemList(this.var_1353);
      ...
      public function close() : void
      {
         if(this.var_782)
         {
            if(this._state != const_195 && this._state != const_248)
            {
      ...
      {
         this.var_56.setMinimized(param1 != InventoryCategory.const_78);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_705 + " OTHER: " + this.var_1106);
         ...
         {
            case const_195:
               if(param1 == const_202 || param1 == const_248)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         if(this.var_245 == null || this.var_245.disposed)
         {
            return _loc1_;
         }
         var _loc4_:int = 0;
         while(_loc4_ < this.var_245.length)
         {
            _loc2_ = this.var_245.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_56.alertPopup(TradingView.const_1177);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_704)
            {
               this.var_705 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1106 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_56.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_704)
            {
               this.var_56.alertPopup(TradingView.const_998);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_245.length < const_1626)
         {
