package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_390:String = "pets";
      ...
      private var var_1555:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_222,this.onObjectPlaced);
         this._catalog = param7;
         this.var_509 = param8;
         this.var_557 = new Timer(const_1253,1);
         this.var_557.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2120 = XML(_loc10_.content);
         this.clearFurniList();
         this.var_16 = new FurniView(this,param2,this._windowManager,this._assets,this._roomEngine,this.var_509);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_222,this.onObjectPlaced);
               }
            ...
            {
               this.var_557.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_557.stop();
               this.var_557 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            ...
            else
            {
               ...
               {
                  this.var_1555 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1555;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_401)
         {
         ...
         else if(param3 == FurniCategory.const_407)
         {
         ...
         if(this.var_845 == null)
         {
            this.var_845 = this._windowManager.buildFromXML(this.var_2120) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_845.clone() as IWindowContainer;
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_394);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_556.add(const_45,new Array());
         this.var_556.add(const_51,new Array());
         if(this.var_16 != null)
         {
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_287;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_401 || _loc3_.category == FurniCategory.const_343 || _loc3_.category == FurniCategory.const_407)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1294 && param1.type == RoomEngineObjectEvent.const_222)
         {
            this.var_1294 = false;
         }
      }
      ...
      {
         return this.var_556.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_556.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_869)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
