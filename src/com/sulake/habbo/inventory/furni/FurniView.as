package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2032:int = 0;
      
      private const const_956:int = 1;
      
      private const const_1704:int = 2;
      
      private const const_1703:int = 3;
      
      private const const_1730:int = 42;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_509 = param6;
         this.var_509.events.addEventListener(SongInfoReceivedEvent.const_887,this.onSongInfoReceivedEvent);
         this.var_426 = new Map();
         this.var_426.add(FurniModel.const_45,new FurniGridView(this.var_69,FurniModel.const_45,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_426.add(FurniModel.const_51,new FurniGridView(this.var_69,FurniModel.const_51,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_509)
            {
               this.var_509.events.removeEventListener(SongInfoReceivedEvent.const_887,this.onSongInfoReceivedEvent);
               this.var_509 = null;
            }
            this.var_623 = null;
            this._disposed = true;
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_426.getValue(this.var_425);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_69.getCategoryContent(this.var_425);
         if(!this.var_69.isListInited())
         {
            _loc2_ = this.const_956;
         }
         ...
         if(this.var_2211 == _loc2_)
         {
            return;
         }
         this.var_2211 = _loc2_;
      ...
      public function clearViews() : void
      {
         ...
         while(_loc4_ < _loc1_.length)
         {
            ...
            _loc3_ = this.var_426.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_426.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_426.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_69.getGroupItemInIndex(_loc3_,this.var_425);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            else if(_loc5_.category == FurniCategory.const_401)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_407)
            {
         ...
         if(_loc13_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               {
                  _loc21_ = this.var_509.musicController.getSongInfo(_loc5_.extra);
                  if(_loc21_ != null)
                  {
                  ...
                  {
                     this.var_509.musicController.requestSongInfoWithoutSamples(_loc5_.extra);
                     this.var_623.push(_loc5_.extra);
                  }
               }
            }
         ...
         if(_loc14_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.category == FurniCategory.const_1058)
               {
                  _loc22_ = this.var_509.musicController.getSongInfo(_loc5_.extra);
                  if(_loc22_ != null)
                  {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         else if(_loc3_ < this.const_1730)
         {
         ...
         else if(param1.type == WindowEvent.const_64)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_390);
            }
         }
      }
      ...
      {
         if(this.var_623.indexOf(param1.id as Number) != -1)
         {
            this.updateActionView();
            while(this.var_623.indexOf(param1.id as Number) != -1)
            {
               this.var_623.splice(this.var_623.indexOf(param1.id as Number),1);
            }
         }
      }
   }
