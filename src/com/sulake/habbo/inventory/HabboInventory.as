package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1362:IncomingMessages;
      ...
      private var var_1099:IRoomSession;
      ...
      private const const_2016:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_482,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_52.getValue(InventoryCategory.const_78));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_52.getValue(InventorySubCategory.const_287));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_52.getValue(InventoryCategory.const_689));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_52.getValue(InventoryCategory.const_293));
      }
      ...
      public function get achievementsModel() : AchievementsModel
      {
         ...
         return AchievementsModel(this.var_52.getValue(InventoryCategory.const_368));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_52.getValue(InventoryCategory.const_153));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_52.getValue(InventoryCategory.const_394) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1362 = new IncomingMessages(this);
      ...
      {
         this.var_294 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_482,this.roomSessionEventHandler);
         this.initInventory();
      }
      
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_509 = IHabboSoundManager(param2);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_94:
               this.var_1099 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_482:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_294 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_187 || !this.var_509)
         {
            return;
         }
         ...
         this.var_52.add(InventoryCategory.const_394,_loc1_);
         var _loc2_:FurniModel = new FurniModel(this,_loc1_,this._windowManager,this._communication,this._assetLibrary,this._roomEngine,this._catalog,this.var_509);
         this.var_52.add(InventoryCategory.const_78,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_294);
         this.var_52.add(InventoryCategory.const_293,_loc3_);
         ...
         this.var_52.add(InventoryCategory.const_689,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_294);
         this.var_52.add(InventoryCategory.const_368,_loc5_);
         ...
         this.var_52.add(InventorySubCategory.const_287,_loc6_);
         ...
         this.var_52.add(InventoryCategory.const_153,_loc8_);
         this.var_189 = true;
         if(this.var_2351)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_287:
               this.var_16.toggleCategoryView(InventoryCategory.const_78,false);
         }
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_889.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_889.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_889.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_889.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2016);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_820));
      }
