package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1458:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_635 = BitmapData(_loc7_.content);
         }
         ...
         this._thumbWidth = this.var_635.width;
         this.var_93 = this.var_635.height;
         this.var_1198 = param5;
         this.var_969 = param6;
         this.var_224 = Math.floor(this.var_1198 / this._thumbWidth);
         this.var_28 = new BitmapData(this.var_1198,this.var_969);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_634 = this.resolveRowCountFromList();
         if(this.var_634 == 0)
         {
            this.var_28 = new BitmapData(this.var_1198,this.var_969);
            return;
         }
         this.var_28 = new BitmapData(Math.max(this.var_224 * this._thumbWidth,this.var_1198),Math.max(this.var_634 * this.var_93,this.var_969),true,16777215);
         this.var_28.fillRect(this.var_28.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_634)
         {
            _loc4_ = 0;
            while(_loc4_ < this.var_224)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     this.var_28.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * this._thumbWidth,_loc3_ * this.var_93),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_224 && this.var_28.height < _loc3_.y * this.var_93)
         {
            _loc2_ = new BitmapData(this.var_28.width,this.var_28.height + this.var_93);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_224 - 1),this.var_93);
         _loc2_.copyPixels(this.var_28,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_224 - 1),0,this._thumbWidth,this.var_28.height);
         _loc2_.copyPixels(this.var_28,_loc4_,new Point(0,this.var_93),null,null,true);
         _loc4_ = new Rectangle(0,this.var_93,this._thumbWidth * (this.var_224 - 1),this.var_28.height - this.var_93);
         _loc2_.copyPixels(this.var_28,_loc4_,new Point(this._thumbWidth,this.var_93),null,null,true);
         this.var_28 = _loc2_;
      }
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1458.getDrawableList();
         }
      ...
      private function resolveRowCountFromList() : int
      {
         ...
         return int(Math.ceil(_loc1_.length / this.var_224));
      }
      ...
      {
         var _loc2_:Point = this.resolveGridLocationFromImage(param1);
         return int(_loc2_.y * this.var_224 + _loc2_.x);
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / this.var_224);
         var _loc3_:int = param1 % this.var_224;
         return new Point(_loc3_,_loc2_);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc11_:* = null;
         var _loc12_:* = null;
         if(param1.x >= this.var_224)
         {
            return;
         }
         if(param1.y >= this.var_634)
         {
            return;
         }
         var _loc4_:int = this.var_224 - param1.x - 1;
         ...
         if(param1.y < this.var_634 - 1)
         {
            _loc7_ = this.var_28.width - this._thumbWidth;
            _loc8_ = this.var_28.height - (param1.y + 1) * this.var_93;
            ...
            this.var_28.fillRect(new Rectangle(0,this.var_28.height - this.var_93,this.var_28.width,this.var_93),4294967295);
            _loc3_ = new Point(this.var_28.width - this._thumbWidth,_loc2_.y - this.var_93);
         ...
         if(_loc6_ > 0)
         {
            ...
            if(param1.x == this.var_224 - 1)
            {
               _loc11_ = new BitmapData(this.var_28.width,this.var_28.height - this.var_93);
               _loc2_ = new Rectangle(0,0,this.var_28.width,this.var_28.height - this.var_93);
               _loc11_.copyPixels(this.var_28,_loc2_,new Point(0,0),null,null,true);
               this.var_28 = _loc11_;
               --this.var_634;
            }
         }
         if(this.var_28.height < this.var_969)
         {
            _loc12_ = new BitmapData(this.var_28.width,this.var_969);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(this.var_635.width,this.var_635.height);
         if(param2)
         {
            _loc3_.copyPixels(this._itemBgImageSelected,this.var_635.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(this.var_635,this.var_635.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
