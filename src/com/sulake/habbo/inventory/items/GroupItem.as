package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2790:BitmapData;
      
      private const const_1984:int = 8947848;
      
      private const const_1983:int = 13421772;
      
      private const const_1702:Number = 1;
      
      private const const_1701:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this._type = param1;
         this._window = param4;
         this.var_1292 = this._window.findChildByTag("BG_COLOR");
         this._roomEngine = param5;
         this.var_2790 = param6;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2789 == FurniModel.const_45)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1354));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2024);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      {
         return this.var_821 == -1;
      }
      
      public function set isSelected(param1:Boolean) : void
      {
         if(this.var_205 != param1)
         {
            this.var_205 = param1;
            this.updateThumbData();
         }
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_869)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1701;
               _loc1_.blend = this.const_1701;
            }
            else
            {
               this._window.blend = this.const_1702;
               _loc1_.blend = this.const_1702;
            }
         }
         if(this.isSelected)
         {
            this.var_1292.color = this.const_1984;
         }
         else
         {
            this.var_1292.color = this.const_1983;
         }
         ...
         if(_loc5_)
         {
            if(this.var_2023 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2790;
               _loc5_.visible = true;
            }
            else
            {
