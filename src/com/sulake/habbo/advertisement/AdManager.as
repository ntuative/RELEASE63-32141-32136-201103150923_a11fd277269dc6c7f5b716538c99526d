package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      {
         this.var_308 = param2 as IHabboCommunicationManager;
         if(this.var_308 == null)
         {
            return;
         }
         this._connection = this.var_308.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2388 = this._config.getKey("interstitial.enabled","FurnitureAliasesMessageEvent") == "true";
         this.var_2387 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2386 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1703 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1118 == 0)
         {
            this.var_1118 = getTimer();
            return false;
         }
         if(this.var_1703 > 0 && this.var_1704 >= this.var_1703)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1118;
         if(_loc1_ > this.var_2387)
         {
            ++this.var_1704;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1378 = _loc2_.imageUrl;
         this.var_2385 = _loc2_.clickUrl;
         this.var_1118 = getTimer();
         if(this.var_1378 != "")
         {
            _loc3_ = this.var_1378;
            ...
            {
               this.var_215 = new Timer(this.var_2386,1);
            ...
            this.var_215.start();
            _loc4_ = new URLRequest(this.var_1378);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_574,0,0,param1.bitmapData,this.var_2385));
            this.var_1118 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_553));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1379 = _loc2_.imageUrl;
         this.var_1705 = _loc2_.clickUrl;
         if(this.var_1379 != "" && this.var_1705 != "")
         {
            _loc3_ = this.var_1379;
            if(assets.hasAsset(_loc3_))
            {
               assets.removeAsset(assets.getAssetByName(_loc3_));
            }
            _loc4_ = new URLRequest(this.var_1379);
            _loc5_ = assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_564,0,0,_loc4_,this.var_1705,this.var_1119,this.var_1120));
         }
      }
