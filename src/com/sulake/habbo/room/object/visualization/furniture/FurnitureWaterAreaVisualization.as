package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      {
         if(this.var_2549 == param1 && this.var_2548 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            ...
            {
               this.var_1826 = _loc2_;
               this.var_2549 = param1;
               this.var_2548 = direction;
               return this.var_1826;
            }
            _loc2_--;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_512 == 0 || this.var_625 == 0)
         {
            ...
            this.var_512 = _loc2_.getNumber(RoomObjectVariableEnum.const_283);
            this.var_625 = _loc2_.getNumber(RoomObjectVariableEnum.const_337);
         }
         this.var_427 = [];
         this.var_626 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_512 * 2 + this.var_625 * 2)
         {
            this.var_427.push(false);
            this.var_626.push(ShoreMaskCreatorUtility.const_77);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_70,getSize(param3),this.var_427,this.var_626,assetCollection);
      }
