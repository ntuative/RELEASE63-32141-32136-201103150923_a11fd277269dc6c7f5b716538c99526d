   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            if(_loc4_ != this._state)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_864);
                  this.var_1647 = _loc6_;
               }
            }
            return true;
         }
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_864);
                     if(_loc4_ > this.var_1647)
                     {
                        this.var_1647 = _loc4_;
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               if(!this._animationData.isImmediateChange(this.var_879,param2,_loc5_))
               {
                  _loc6_ = AnimationData.getTransitionFromAnimationId(_loc5_);
                  if(this._animationData.hasAnimation(this.var_879,_loc6_))
                  {
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_115 != null)
         {
            this.var_115.setLayerCount(this.var_584);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         if(param1 != this.var_879)
         {
            this.var_879 = param1;
            this.var_584 = this._animationData.getLayerCount(param1);
      ...
      {
         var _loc2_:* = null;
         if(!this.var_115.animationOver || this.var_878)
         {
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : Array
      {
         ...
         var _loc10_:* = null;
         var _loc11_:int = 0;
         if(param1.animationOver && !this.var_878)
         {
            return null;
         }
         ...
         var _loc7_:int = this.var_584 - 1;
         while(_loc7_ >= 0)
         {
            _loc8_ = param1.getAnimationPlayed(_loc7_);
            if(!_loc8_ || this.var_878)
            {
               ...
               if(this.var_878 || _loc10_ == null || _loc10_.remainingFrameRepeats >= 0 && _loc12_ <= 0)
               {
                  _loc11_ = 0;
                  if(_loc10_ != null)
                  {
                  ...
                  if(_loc11_ == AnimationFrame.const_1119)
                  {
               ...
               if(_loc10_ == null || _loc10_.remainingFrameRepeats == AnimationFrame.const_447)
               {
                  _loc9_ = true;
                  _loc8_ = true;
               }
