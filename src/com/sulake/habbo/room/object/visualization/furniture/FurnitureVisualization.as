package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1693:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2405:Number = NaN;
      
      private var var_2407:int = -1;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1128:String = null;
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_452 != _loc3_.getUpdateID() || param1 != var_98 || param2 != this.var_2405)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2407 = _loc3_.getNumber(RoomObjectVariableEnum.const_243);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_349));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1128 = _loc3_.getString(RoomObjectVariableEnum.const_341);
            if(this.var_1128 == null || this.var_1128.indexOf("http") != 0)
            {
               this.var_1128 = null;
            }
      ...
      {
         if(this.var_2404 != param2 || this.var_2406 != param1)
         {
            this.var_896 = [];
            this.var_895 = [];
            this.var_728 = [];
            ...
            this.var_2403 = this.getSize(param1);
      ...
      {
         this.var_584 = param1;
         this.var_1715 = this.var_584 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_422.length)
         {
            return "";
         }
         var _loc3_:String = this.var_896[param2];
         var _loc4_:Boolean = this.var_895[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2403;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1715)
            {
               _loc6_ = FurnitureVisualizationData.const_422[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_896[param2] = _loc3_;
            this.var_895[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_733[param3] != null && !this.var_1714)
         {
      ...
      {
         if(this.var_727[param2] != null)
         {
            return this.var_727[param2];
         }
         if(this._data == null)
         {
      ...
      {
         if(this.var_731[param3] != null)
         {
            return this.var_731[param3];
         }
         if(this._data == null)
         {
            return true;
