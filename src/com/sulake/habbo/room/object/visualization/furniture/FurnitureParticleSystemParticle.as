package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemParticle
   {
      ...
      public function init(param1:Number, param2:Number, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:int, param8:Boolean = false, param9:Array = null, param10:Boolean = false) : void
      {
         ...
         this.var_1624 = this.var_153 - this._direction.y * param6;
         this.var_1623 = this.var_152 - this._direction.z * param6;
         this.var_471 = 0;
         this.var_1080 = false;
         this.var_865 = param7;
         ...
         this.var_1486 = 0.5 + Math.random() * 0.5;
      }
      
      public function update() : void
      {
         ++this.var_471;
         if(this.var_471 == this.var_865)
         {
            this.ignite();
         }
         if(this.var_1626)
         {
            if(this.var_471 / this.var_865 > this.var_1486)
            {
               this._alphaMultiplier = (this.var_865 - this.var_471) / (this.var_865 * (1 - this.var_1486));
            }
         }
      }
      ...
      public function getAsset() : IGraphicAsset
      {
         ...
         {
            return this._frames[this.var_471 % this._frames.length];
         }
         return null;
      }
      ...
      {
         return this.var_471 <= this.var_865;
      }
