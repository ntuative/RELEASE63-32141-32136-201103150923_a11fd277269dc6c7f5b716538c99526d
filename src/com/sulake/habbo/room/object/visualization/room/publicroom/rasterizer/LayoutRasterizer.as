package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_703:IGraphicAssetCollection;
      ...
      private var var_1172:Point = null;
      
      private var var_1423:LayoutRasterizerData = null;
      ...
      {
         if(param1 != this.var_945)
         {
            this.var_945 = param1;
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1423 = this.var_44.getValue(this.var_945);
         }
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         this.var_1172.x = _loc3_.x;
         this.var_1172.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_44.getValue(this.var_945);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1806 = RoomObjectVariableEnum.const_1049;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1806 = RoomObjectVariableEnum.const_1062;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1173 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1173 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_44.getValue(this.var_945);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2526 && param3 == this.var_2525)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1173 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1173 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1806);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_456;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1423.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_703.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1172.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1172.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_424.indexOf(_loc10_) >= 0 && this.var_946)
            {
               param1 = this.var_424.indexOf(_loc10_);
               if(this.var_620[param1] != "")
               {
                  _loc9_ = this.var_703.getAsset(this.var_620[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
