package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1406:int = const_374;
      ...
      public static const const_281:int = const_119;
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_716 != null)
         {
            this.var_716.assign(new Vector3d());
         }
         this.var_578 = 0;
         var _loc1_:int = 0;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_32 != null)
            {
               if(this.var_32.width == param2 && this.var_32.height == param3 && Vector3d.isEqual(this.var_716,param4))
               {
                  if(param1 != null)
                  {
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1676 == const_119)
         {
            _loc5_ = new Rectangle(0,0,this.var_32.width,this.var_578);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_32.height - this.var_578,this.var_32.width,this.var_578);
         }
