   ...
   public class PlaneMaterialCellColumn
   {
      ...
      public function render(param1:int, param2:IVector3d) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_32 != null)
            {
               if(this.var_32.height == param1 && Vector3d.isEqual(this.var_716,param2))
               {
                  return this.var_32;
               }
               this.var_32.dispose();
         ...
         if(this.var_32 == null)
         {
            this.var_32 = new BitmapData(this._width,param1,true,16777215);
         }
         this.var_716.assign(param2);
