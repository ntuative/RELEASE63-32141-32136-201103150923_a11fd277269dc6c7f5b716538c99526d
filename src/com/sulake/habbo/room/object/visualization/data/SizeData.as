package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_339:int = 1000;
      ...
      private var var_1466:int = 360;
      
      private var var_773:DirectionData = null;
      
      private var var_267:Map;
      
      private var _colors:Map;
      
      private var var_1207:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_773 = new DirectionData(param1);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_267 != null)
         {
            ...
            {
               _loc2_ = this.var_267.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_773,_loc2_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_267.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            _loc3_ = new DirectionData(this.layerCount);
            _loc3_.copyValues(this.var_773);
            this.defineDirection(_loc3_,_loc8_);
            this.var_267.add(String(_loc7_),_loc3_);
            this.var_1882 = -1;
            this.var_1207 = null;
            _loc5_++;
         }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         while(_loc4_ < param2.length())
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc6_,LayerData.const_1029);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc6_,LayerData.const_1003);
                  break;
               case "DARKEN":
            ...
            if(_loc9_.length > 0)
            {
               param1.setAlpha(_loc6_,int(_loc9_));
            }
            _loc10_ = int(_loc5_.@ignoreMouse);
            param1.setIgnoreMouse(_loc6_,_loc10_ != 0);
            _loc11_ = int(_loc5_.@x);
            param1.setXOffset(_loc6_,_loc11_);
            _loc12_ = int(_loc5_.@y);
            param1.setYOffset(_loc6_,_loc12_);
            _loc13_ = int(_loc5_.@z);
            param1.setZOffset(_loc6_,Number(_loc13_) / -1000);
            _loc4_++;
         }
         return true;
      }
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1466 / 2) % 360 / this.var_1466;
         if(this.var_267.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         {
            _loc6_ = int(this.var_267.getKey(_loc5_)) * this.var_1466;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_267.getKey(_loc4_));
         }
         return const_1487;
      }
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = this.var_267.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_773;
         }
