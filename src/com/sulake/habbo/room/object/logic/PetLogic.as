   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2463)
         {
            ...
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1394 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
            if(param1 is RoomObjectAvatarPetGestureUpdateMessage)
            {
               _loc6_ = param1 as RoomObjectAvatarPetGestureUpdateMessage;
               _loc2_.setString(RoomObjectVariableEnum.const_128,_loc6_.gesture);
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_691,Number(getTimer()));
         ...
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc11_ = _loc2_.getString(RoomObjectVariableEnum.const_201);
            _loc2_.setString(RoomObjectVariableEnum.const_201,_loc10_.figure);
            _loc2_.setString(RoomObjectVariableEnum.const_1597,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_733,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_182,_loc3_ + this.var_907);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1752;
            _loc2_.setNumber(RoomObjectVariableEnum.const_271,this.var_1752);
            _loc2_.setNumber(RoomObjectVariableEnum.const_128,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1753;
            _loc2_.setNumber(RoomObjectVariableEnum.const_128,this.var_1753);
         }
         else
         {
            this.var_907 += 45;
      ...
      private function updateActions(param1:int, param2:IRoomObjectModelController) : void
      {
         ...
         {
            param2.setString(RoomObjectVariableEnum.const_128,null);
            this.var_1395 = 0;
         }
         if(this.var_1394 > 0)
         {
