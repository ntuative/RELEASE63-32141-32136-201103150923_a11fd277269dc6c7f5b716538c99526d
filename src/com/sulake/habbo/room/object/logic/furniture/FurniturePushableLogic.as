package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_1723:int = 1;
      
      private static const const_951:int = 10;
       
      
      private var var_1740:Vector3d = null;
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            this.var_1740.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),this.var_1740).length == 0)
            {
