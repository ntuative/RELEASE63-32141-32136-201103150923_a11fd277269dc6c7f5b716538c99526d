package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1310:uint = 16777215;
      
      private var var_1584:int = 255;
      
      private var var_1064:uint = 16777215;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_793,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1065)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1572;
            if(_loc2_ - this.var_1065 >= this.var_1585)
            {
               _loc3_ = this.var_1064;
               _loc4_ = this.var_1583;
               this.var_1065 = 0;
            }
            else
            {
               _loc7_ = this.var_1310 >> 16 & 255;
               _loc8_ = this.var_1310 >> 8 & 255;
               _loc9_ = this.var_1310 & 255;
               _loc10_ = this.var_1064 >> 16 & 255;
               _loc11_ = this.var_1064 >> 8 & 255;
               _loc12_ = this.var_1064 & 255;
               _loc13_ = (_loc2_ - this.var_1065) / this.var_1585;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1584 + (this.var_1583 - this.var_1584) * _loc13_;
               this._color = _loc3_;
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectRoomUpdateMessage.const_848:
               param2.setString(RoomObjectVariableEnum.const_706,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_845:
               param2.setString(RoomObjectVariableEnum.const_866,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_483:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_250)
               {
                  _loc5_ = "null";
               }
               this.var_535.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_871:
               _loc4_ = this.var_535.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_535.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1096,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1200:
               param2.setNumber(RoomObjectVariableEnum.const_793,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1078:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1154,int(param1.bgOnly));
         this.var_1310 = this._color;
         this.var_1584 = this.var_1572;
         this.var_1064 = _loc3_;
         this.var_1583 = _loc4_;
         this.var_1065 = getTimer();
         this.var_1585 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1627,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1528,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1630,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_159 || _loc13_ == RoomPlaneData.const_305)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
