package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_628:String = "RCL_LOADER_READY";
      
      private static const const_329:String = "RCL_PUBLICROOM_";
      
      private static const const_1727:int = 0;
      
      private static const const_956:int = 1;
      
      private static const name_3:int = 2;
      
      private static const const_415:String = "place_holder";
      
      private static const const_598:String = "wall_place_holder";
      
      private static const const_599:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_415;
      
      private static const const_597:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_955:String = "selection_arrow";
      ...
      private var var_903:Map = null;
      
      private var var_202:PublicRoomData = null;
      
      private var var_1388:Map = null;
      ...
      {
         this.var_350 = new Dictionary();
         this._wallItems = new Dictionary();
         this.var_415 = new Dictionary();
         this.var_2454 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      {
         if(this._state >= const_956)
         {
            return;
         }
         this._stateEvents = param1;
         this.var_2455 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2453 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2452 = param2.getKey("public.room.dynamic.download.url","");
         this._publicRoomLoadNameTemplate = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         this._state = const_956;
         this.initFurnitureData();
      }
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_294.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_417.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_417.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc2_.type == "s")
            {
               ...
               if(this.var_350[_loc7_] == null)
               {
                  this.var_350[_loc7_] = 1;
               }
            }
            ...
            _loc8_ = this.var_603.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_603.remove(_loc7_);
               this.var_603.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2451)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_628));
            }
         }
      }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_314;
         }
         return RoomObjectCategoryEnum.const_158;
      }
      ...
      {
         return [const_415,const_598,const_599,const_597,TILE_CURSOR,const_955];
      }
      ...
      {
         var _loc3_:String = this.var_602.getValue(param1) as String;
      ...
      {
         return this.var_904.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_903[param1];
         if(_loc3_ != null)
         {
      ...
      {
         if(this.var_202 != null && this.var_202.hasWorldType(const_329 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_216 || param1 == RoomObjectVisualizationEnum.const_71 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_32 || _loc2_ == RoomObjectCategoryEnum.const_27)
         {
            ...
            return int(this.var_603.getValue(param1));
         }
         return 0;
      }
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2452 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_32:
                     if(this.var_350[_loc4_] == null)
                     {
                        this.var_350[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_389,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1388.getValue(param1) != null)
         {
            this.var_202 = this.var_1388.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_708,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2454.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1655);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            else if(this.var_415[_loc5_] != null)
            {
               this.extractPetDataFromLoadedContent(_loc5_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_389,_loc5_);
         }
         else
         {
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc6_ = this.var_415[param1];
            this.var_903.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1388.add(param1,_loc4_);
         this.var_202 = _loc4_;
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_417.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_417[_loc2_] != null)
         {
            _loc3_ = this.var_417.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      {
         if(this.getObjectCategory(const_329 + param1) == RoomObjectCategoryEnum.const_79)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_202.getWorldHeightScale(const_329 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_202 != null)
         {
            return this.var_202.getWorldScale(const_329 + param1);
         }
         return 32;
      }
