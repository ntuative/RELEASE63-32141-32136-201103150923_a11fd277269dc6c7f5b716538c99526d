package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_356:ICatalogNavigator;
      ...
      private var var_298:ChargeConfirmationDialog;
      ...
      private var var_1160:ClubGiftController;
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._communication.addHabboConnectionMessageEvent(new RecyclerPrizesMessageEvent(this.method_6));
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_356.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this._configuration.getKey("client.credits.embed.enabled","FurnitureAliasesMessageEvent") == "true";
         if(false && _loc1_)
         {
      ...
      {
         return this.var_294.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_294.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_81)
         {
            _loc3_ = this.var_294.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_100.getActivityPointsForType(Purse.const_204)));
         var _loc1_:int = 0;
      ...
      {
         this.var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_129,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_669)
         {
            if(!this.var_294.loadProductData(this))
            {
               return;
            }
            this.init();
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_297.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_356 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_297 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_297.habboCatalog = this;
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1160 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_356.buildCatalogIndex(_loc2_);
         if(this.var_752 && this.var_752 != "")
         {
            this.var_356.openPage(this.var_752);
            this.var_752 = "";
            this.var_920 = -1;
         }
         else if(this.var_920 > -1)
         {
            this.var_356.openPageById(this.var_920,this.var_1772);
            this.var_920 = -1;
            this.var_1772 = -1;
            this.var_752 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_297.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_297.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2501 && this.var_509 != null)
         {
            this.var_509.playSound(HabboSoundTypesEnum.const_1081);
         }
         this.var_2501 = false;
         if(this.var_298 != null)
         {
            this.var_298.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_65,this.var_100.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2500 && this.var_509 != null)
         {
            this.var_509.playSound(HabboSoundTypesEnum.const_1153);
         }
         this.var_2500 = false;
         if(this.var_298 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1160.include(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_297.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_298 == null)
         {
            this.var_298 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_298.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_297.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
