package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         _loc4_ = this.var_236.getWithIndex(this.var_283);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(this.var_680);
            if(_loc3_ == null)
            {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_236.getWithIndex(this.var_283);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(this.var_680);
            if(_loc3_ == null)
            {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_283;
         if(this.var_283 >= this.var_236.length)
         {
            this.var_283 = 0;
         }
         var _loc2_:Map = this.var_236.getWithIndex(this.var_283);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_283 < 0)
         {
            this.var_283 = this.var_236.length - 1;
         }
         var _loc2_:Map = this.var_236.getWithIndex(this.var_283);
         if(_loc2_ != null)
         {
