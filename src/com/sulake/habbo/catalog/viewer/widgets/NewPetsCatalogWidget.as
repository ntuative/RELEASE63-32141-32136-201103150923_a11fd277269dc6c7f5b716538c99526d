package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1315:int = 18;
      ...
      private var var_191:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_2113 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_191 != null && this.var_191.length > 0)
         {
            this.var_353 = this.var_191[0];
         }
         else
         {
            this.var_353 = -1;
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_191 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1315 && _loc2_ < this.var_191.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_504,this.var_191[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_191 != null && this.var_191.length > 0)
         {
            ...
            this.var_353 = this.var_191[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_504,this.var_353),this.getRaceLocalizationKey(this.var_504,this.var_353));
            }
         }
         return this.getRaceLocalizationKey(this.var_504,this.var_353);
      }
