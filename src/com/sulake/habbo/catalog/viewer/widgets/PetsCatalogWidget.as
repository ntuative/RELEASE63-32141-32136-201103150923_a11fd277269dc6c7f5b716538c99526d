package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IPetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_2113 = _loc3_.localizationId;
         this.var_333 = [];
         if(page && false && page.viewer.catalog)
         {
         ...
         events.addEventListener(WidgetEvent.const_617,this.onApproveNameResult);
      ...
      public function onDropMenuEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowEvent.const_64)
         {
            ...
            if(this.var_191 == null || _loc3_ >= this.var_191.length)
            {
               return;
            }
            this.var_678 = _loc3_;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         this.var_463 = param1.index;
         if(this.var_463 < 0 || this.var_463 > this.var_333.length)
         {
            this.var_463 = 0;
         }
         this.updateImage();
      ...
      {
         if(param1.productCode == this.var_2113)
         {
            this.var_191 = this.parseSellableBreeds(param1.sellableBreeds);
            this.var_678 = 0;
      ...
      private function updateBreedSelections() : void
      {
         ...
         {
            _loc5_ = this.var_191[_loc3_] as int;
      ...
      private function updateImage() : void
      {
         ...
         if(this.var_191 == null || this.var_678 >= this.var_191.length)
         {
            return;
         }
         var _loc2_:* = 0;
         if(this.var_463 >= 0 && this.var_463 < this.var_333.length)
         {
            _loc7_ = this.var_333[this.var_463] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:int = this.var_191[this.var_678] as int;
         ...
         _loc4_.appendAction(AvatarAction.const_282,AvatarAction.const_713);
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(this.var_463 >= this.var_333.length)
         {
            return "";
         }
         var petColor:IPetColor = this.var_333[this.var_463] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:int = this.var_191[this.var_678] as int;
      ...
      private function updateAvailableBreeds(param1:String) : void
      {
         ...
         if(this.var_191 == null)
         {
            ...
            this.var_191 = this.parseSellableBreeds(_loc2_);
            this.var_678 = 0;
            if(this.var_191 != null)
            {
               this.updateBreedSelections();
