package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1871:Point;
      
      private var var_518:IItemGridWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_970 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1200 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_88 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1871 = new Point(this.var_88.x,this.var_88.y);
         this.var_518 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         ...
         this.var_1872 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_970.text = _loc4_;
         this.var_1200.text = _loc5_;
         this.var_970.height = this.var_970.textHeight + 5;
         this.var_1200.y = this.var_970.y + this.var_970.height;
         this.var_1200.height = Math.max(130,this.var_1200.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_445:
                  _loc6_ = this.var_1872.clone();
                  if(this.var_518 != null)
                  {
                     this.var_518.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_518,this.var_1459,this.var_1556);
                     this.var_518.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_236:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_282,AvatarAction.const_539);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_88 != null && true)
         {
            ...
            this.var_88.x = this.var_1871.x;
            this.var_88.y = this.var_1871.y;
            if(param3 != null)
            {
