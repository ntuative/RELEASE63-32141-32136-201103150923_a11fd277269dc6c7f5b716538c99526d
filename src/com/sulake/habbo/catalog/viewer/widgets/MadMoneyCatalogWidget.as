package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MadMoneyCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_949:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_949.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.eventProc);
            this.var_949 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_949 = _window.findChildByName("ctlg_madmoney_button") as IButtonWindow;
         if(this.var_949 != null)
         {
            this.var_949.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.eventProc);
         }
         return true;
      }
