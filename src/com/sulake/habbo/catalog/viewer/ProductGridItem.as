package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_938:String = "bg";
      ...
      {
         this.var_16.getChildByName(const_938).style = HabboWindowStyle.const_31;
      }
      
      public function deActivate() : void
      {
         this.var_16.getChildByName(const_938).style = 3;
      }
