package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_486:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1125:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_486 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1126);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1126);
      }
      ...
      protected function createWindow(param1:String) : Boolean
      {
         ...
         this.var_2035 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2035) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1546:
               if(this.var_1125 == null)
               {
                  this.var_1125 = new ItemGridCatalogWidget(param1);
                  this.var_48.push(this.var_1125);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1628:
               ...
               break;
            case CatalogWidgetEnum.const_1398:
            ...
            case CatalogWidgetEnum.const_1676:
               ...
               break;
            case CatalogWidgetEnum.const_1407:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_486.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_486 != null)
         {
            return this.var_486.dispatchEvent(param1);
         }
         return false;
      }
   }
