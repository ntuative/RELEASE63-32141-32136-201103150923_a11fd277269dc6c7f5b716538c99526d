package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const LAYOUTS_TEXT_FIELDS:Object = {
         ...
         "mad_money":["ctlg_header_text","ctlg_description","ctlg_madmoney_button"]
      };
      
      private static const const_172:Dictionary = new Dictionary();
      
      private static const const_940:Object = {"frontpage3":[7,8]};
      
      private static const const_939:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < this.var_696.length)
         {
            _loc2_ = String(this.var_696[param1]).replace("#","0x");
