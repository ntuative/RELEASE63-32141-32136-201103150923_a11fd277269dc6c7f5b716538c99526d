package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private var var_1878:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1878 == 4294967295)
            {
               this.var_1878 = _loc1_.color;
            }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1551;
            }
         }
      }
      ...
      {
         this.var_63 = navigator.catalog.windowManager.buildFromXML(var_1462) as IItemListWindow;
         if(this.var_63 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1463) as IWindowContainer;
         }
         else
         {
