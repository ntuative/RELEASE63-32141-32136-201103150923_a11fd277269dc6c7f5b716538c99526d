package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2870:String = "magic.credits";
      
      private var var_2834:String = "magic.pixels";
      
      private var var_2835:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2834);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2835,true);
      }
