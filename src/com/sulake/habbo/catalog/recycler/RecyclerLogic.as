package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_598 != const_949;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1739 != RecyclerStatusMessageEvent.const_1221;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_598 == const_414;
      }
      ...
      {
         this.var_598 = const_950;
         this.var_117 = new Array(const_173);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1011:
               if(this.var_16 != null)
               {
                  this.var_16.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1425:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_117.length < const_173)
         {
            return false;
         }
         var _loc1_:int = 0;
