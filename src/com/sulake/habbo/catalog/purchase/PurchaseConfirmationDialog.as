package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_2026:int = 10;
      ...
      private const const_1746:uint = 4.293848814E9;
      
      private const const_1745:uint = 4.294967295E9;
      
      private const const_2027:uint = 4.291613146E9;
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_81:
                  ...
                  break;
               case ProductTypeEnum.const_236:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1850 = _loc1_.stuffTypes;
            this.var_798 = _loc1_.boxTypes;
            this.var_799 = _loc1_.ribbonTypes;
            this.var_1235 = this.var_1850[0];
            this.var_377 = this.var_798[0];
            this.var_378 = this.var_799[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_378 < 0)
         {
            this.var_378 = this.var_799.length - 1;
         }
         if(this.var_378 > this.var_799.length - 1)
         {
            this.var_378 = 0;
         }
         if(this.var_377 < 0)
         {
            this.var_377 = this.var_798.length - 1;
         }
         if(this.var_377 > this.var_798.length - 1)
         {
            this.var_377 = 0;
         }
         var _loc1_:int = this.var_798[this.var_377] * 1000 + this.var_799[this.var_378];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_94.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1235,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1496 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1850;
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_798[this.var_377]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_799[this.var_378]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_94,this.var_1495,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_94.offerId,this.var_1495);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_105:
               ...
               for each(_loc7_ in this.var_210)
               {
                  ...
                  if(_loc5_.length >= this.const_2026)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2722 = _loc3_.text;
               break;
            case WindowMouseEvent.const_46:
               ...
               break;
            case WindowKeyboardEvent.const_405:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_376 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_376 + 1);
                     break;
      ...
      {
         if(this.var_271 == null || !this.var_271.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_271.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_376) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_271 == null)
         {
            this.var_271 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_647 == null)
         {
         ...
         if(this.var_271 == null || this.var_647 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_271.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_376) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_376);
         }
         this.var_376 = param1;
         if(this.var_376 < 0)
         {
            this.var_376 = _loc2_.numListItems - 1;
         }
         if(this.var_376 >= _loc2_.numListItems)
         {
            this.var_376 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_376) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_2027;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1746) : uint(this.const_1745);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_271.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
