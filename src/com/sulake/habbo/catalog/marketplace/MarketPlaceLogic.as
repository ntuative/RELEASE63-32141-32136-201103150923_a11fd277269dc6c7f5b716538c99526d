package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_1822:int = 1;
      
      public const const_1819:int = 2;
      
      public const const_2036:int = 3;
      ...
      private var var_2158:int = -1;
      
      private var var_2168:MarketplaceItemStats;
      ...
      {
         this.requestOffers(this.var_2171,this.var_2172,this.var_2170,this.var_2166);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_1822,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         var _loc1_:Array = this.var_285.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = this.var_285.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_578)
            {
               this.var_285.remove(_loc2_);
               _loc3_.dispose();
            }
         }
         if(this._catalog)
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2169 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_1819,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_285.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2167 || param1.furniTypeId != this.var_2173)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1260)
               {
                  _loc2_ = true;
               }
            }
