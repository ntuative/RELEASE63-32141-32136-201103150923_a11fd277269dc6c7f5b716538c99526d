package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_989:IHabboLocalizationManager;
      
      private var var_783:IHabboConfigurationManager;
      
      private var var_294:ISessionDataManager;
      
      private var var_1220:FaqIndex;
      ...
      private var var_784:HotelMergeUI;
      
      private var var_1479:CallForHelpData;
      
      private var var_2676:UserRegistry;
      
      private var var_2320:String = "";
      
      private var var_642:WelcomeScreenController;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1479 = new CallForHelpData();
         this.var_2676 = new UserRegistry();
         super(param1,param2,param3);
         this._assetLibrary = param3;
         this.var_1220 = new FaqIndex();
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_989)
         {
            this.var_989.release(new IIDHabboLocalizationManager());
            this.var_989 = null;
         }
         if(this.var_308)
         {
         ...
         if(this.var_783)
         {
            this.var_783.release(new IIDHabboConfigurationManager());
            this.var_783 = null;
         }
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return this.var_783.getKey(param1,param2,param3);
      }
      ...
      public function reportUser(param1:int, param2:String) : void
      {
         ...
         this.var_66.showUI(HabboHelpViewEnum.const_365);
      }
      ...
      private function createHelpUI() : Boolean
      {
         ...
         {
            this.var_66 = new HelpUI(this,this._assetLibrary,this._windowManager,this.var_989,this.var_187);
         }
      ...
      public function initHotelMergeUI() : void
      {
         if(!this.var_784)
         {
            this.var_784 = new HotelMergeUI(this);
         }
         this.var_784.startNameChange();
      }
      ...
      public function startNameChange() : void
      {
         if(this.var_106)
         {
            this.var_106.showView(TutorialUI.const_278);
         }
      }
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1362 = new IncomingMessages(this,this.var_308);
      ...
      {
         this.var_989 = IHabboLocalizationManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),this.onConfigurationManagerReady);
      }
      
      private function onConfigurationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_783 = IHabboConfigurationManager(param2);
      ...
      private function showWelcomeScreen(param1:Boolean) : void
      {
         if(!this.var_642)
         {
            this.var_642 = new WelcomeScreenController(this,this._windowManager,this.var_783);
         }
         this.var_642.showWelcomeScreen(param1);
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this.var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_129,HabboToolbarIconEnum.HELP));
         }
      }
      ...
      public function setWelcomeScreenCategory(param1:String, param2:String = "", param3:String = "") : void
      {
         ...
         this.var_642.setCategory(param1,param2,param3);
      }
   }
}
