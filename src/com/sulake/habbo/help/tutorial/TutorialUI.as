package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_278:String = "TUI_NAME_VIEW";
      
      public static const const_356:String = "TUI_CLOTHES_VIEW";
      ...
      private var var_360:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_464,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_428,this.onTaskDoneEvent);
         if(this.var_35.sessionDataManager != null)
         {
            this.var_35.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_275,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1180 && this.var_1179 && this.var_1428;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_35)
         {
            ...
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_464,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_428,this.onTaskDoneEvent);
            if(this.var_35.sessionDataManager != null)
            {
               this.var_35.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_275,this.onFigureUpdate);
            }
            this.var_35 = null;
         }
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_45 == null || this.var_45.id == const_93)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_435:
               this.var_1428 = true;
               if(this.var_45 != null && this.var_45.id == const_555)
               {
                  this.showView(const_93);
               }
               break;
            case HabboHelpTutorialEvent.const_464:
               if(this.var_45 != null && this.var_45.id == const_356)
               {
                  this.var_1818 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2287 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_278:
               ...
               if(this.var_360 == null)
               {
                  this.var_360 = new NameChangeView(this);
               }
               this.var_360.showMainView();
               this.prepareForTutorial();
               break;
            case const_356:
         ...
         this._window.height = _loc2_.height + this.var_2286;
         this._window.width = _loc2_.width + this.var_2287;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_45 != null && (this.var_45.id == const_278 || this.var_45.id == const_93))
         {
            this.showView(const_93);
         }
      }
      ...
      {
         this.var_1180 = true;
         if(this.var_45 != null && (this.var_45.id == const_356 || this.var_45.id == const_93))
         {
            this.showView(const_93);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_537)
         {
            this.var_1179 = true;
         ...
         {
            this.var_360.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_537)
         {
            this.var_360.checkedName = _loc2_.name;
         }
         else
         {
            this.var_360.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
