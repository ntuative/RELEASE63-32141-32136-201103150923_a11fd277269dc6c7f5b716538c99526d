package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1431:uint = 13232628;
      
      private static var var_1823:uint = 11129827;
      ...
      private var var_1182:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1824 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_760)
         {
            this.var_760 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_760)
            {
               return;
            }
            this._window.content.addChild(this.var_760);
         }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_817:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_816:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1015 || param1 == ChangeUserNameResultMessageEvent.var_1016)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1182 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1182.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1431;
