package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_338 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201103150919));
         this.var_187 = param5;
         this.var_114 = new Map();
         this.var_114.add(HabboHelpViewEnum.const_1554,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_181,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_508,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_309,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_227,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_365,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_627,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_244,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_114.add(HabboHelpViewEnum.const_1152,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_114.add(HabboHelpViewEnum.const_1182,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_114.add(HabboHelpViewEnum.const_909,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_472.length == 0 || param1 != this.var_338)
            {
               this.var_472.push(this.var_338);
            }
         }
         this.var_338 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_338);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_1179:
               this.showUI(HabboHelpViewEnum.const_1182);
               break;
            case CallForHelpResultEnum.const_1225:
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_114.getValue(HabboHelpViewEnum.const_181) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_23.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_435));
      }
      ...
      {
         return this.var_114.getValue(this.var_338);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2287 = this._window.width - _loc4_.width;
         this.var_2286 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2286;
         this._window.width = _loc1_.width + this.var_2287;
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_338 == HabboHelpViewEnum.const_181)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_338 == HabboHelpViewEnum.const_181 || this.var_472.length == 0)
         {
            return;
         }
         if(this.var_337 == null)
